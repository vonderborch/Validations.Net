...
public static class ContainsAnyValidations
{
    ...
    public static bool CheckContainsAny<T>(this IEnumerable<T> collection, IEnumerable<T> items,
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny<T>(this ICollection<T> collection, IEnumerable<T> items,
        IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny<T>(this IEnumerable<T> collection, ICollection<T> items,
        IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny<T>(this ICollection<T> collection, ICollection<T> items,
        IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny<T>(this IEnumerable<T> collection, IEqualityComparer<T>? comparer = null,
        params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny<T>(this ICollection<T> collection, IEqualityComparer<T>? comparer = null,
        params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAny<T>(this IEnumerable<T> collection, IEnumerable<T> items,
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAny<T>(this ICollection<T> collection, IEnumerable<T> items,
        string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAny(items, comparer))
        {
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAny<T>(this IEnumerable<T> collection, ICollection<T> items,
        string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAny(items, comparer))
        {
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAny<T>(this ICollection<T> collection, ICollection<T> items,
        string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAny(items, comparer))
        {
    ...
    /// <summary>
    ///     Validates that the collection contains at least one of the specified items provided as parameters, throwing an
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAny<T>(this IEnumerable<T> collection, string variableName,
        IEqualityComparer<T>? comparer = null, params T[] items)
    {
        if (!collection.CheckContainsAny(comparer, items))
        {
            throw new ValidationException(variableName,
                $"{variableName} must contain at least one of the specified items.", "ContainsAny", null,
                new Dictionary<string, object?>
                {
                    { "collection", collection },
                    { "items", items }
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAny<T>(this ICollection<T> collection, string variableName,
        IEqualityComparer<T>? comparer = null, params T[] items)
    {
        if (!collection.CheckContainsAny(comparer, items))
        {
    ...
    /// <summary>
    ///     Validates that the collection contains at least one item that satisfies the specified predicate, throwing an
    ///     exception if it does not.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <param name="collection">The collection to validate.</param>
    ...
    ///     Thrown when the collection does not contain any item that satisfies the
    ///     predicate.
    /// </exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAny<T>(this IEnumerable<T> collection, Func<T, bool> predicate,
        string variableName, object? blackboard = null)
    {
        if (!collection.CheckContainsAny(predicate))
        {
            throw new ValidationException(variableName,
                $"{variableName} must contain at least one item that matches the predicate.", "ContainsAny", blackboard,
                new Dictionary<string, object?>
                {
                    { "collection", collection },
                    { "predicate", predicate }
    ...
    /// </exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAny<T>(this ICollection<T> collection, Func<T, bool> predicate,
        string variableName, object? blackboard = null)
    {
        if (!collection.CheckContainsAny(predicate))
        {
