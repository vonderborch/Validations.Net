...
public static class DoesNotContainAnyValidations
{
    ...
    public static bool CheckDoesNotContainAny<T>(this IEnumerable<T> collection, IEnumerable<T> items,
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny<T>(this ICollection<T> collection, IEnumerable<T> items,
        IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny<T>(this IEnumerable<T> collection, ICollection<T> items,
        IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny<T>(this IEnumerable<T> collection, IEqualityComparer<T>? comparer = null,
        params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny<T>(this ICollection<T> collection, IEqualityComparer<T>? comparer = null,
        params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContainAny<T>(this IEnumerable<T> collection, IEnumerable<T> items,
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains any of the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContainAny<T>(this ICollection<T> collection, IEnumerable<T> items,
        string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContainAny(items, comparer))
        {
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains any of the specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContainAny<T>(this IEnumerable<T> collection, ICollection<T> items,
        string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContainAny(items, comparer))
        {
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains any of the specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContainAny<T>(this IEnumerable<T> collection, string variableName,
        IEqualityComparer<T>? comparer = null, params T[] items)
    {
        if (!collection.CheckDoesNotContainAny(comparer, items))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain any of the specified items.",
                "DoesNotContainAny", null, new Dictionary<string, object?>
                {
                    { "collection", collection },
                    { "items", items }
                });
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains any of the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContainAny<T>(this ICollection<T> collection, string variableName,
        IEqualityComparer<T>? comparer = null, params T[] items)
    {
        if (!collection.CheckDoesNotContainAny(comparer, items))
        {
