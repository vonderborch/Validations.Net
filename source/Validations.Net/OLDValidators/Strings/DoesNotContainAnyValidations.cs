...
public static class DoesNotContainAnyValidations
{
    ...
    /// <remarks>
    ///     Note: The method name suggests it checks if a string does NOT contain any items, but it returns true if it
    ///     DOES contain any.
    /// </remarks>
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny(this string? value, ICollection<string> items,
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny(this string? value,
        StringComparison comparisonType = StringComparison.Ordinal, params string[] items)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny(this string? value, IEnumerable<string> items,
        StringComparison comparisonType = StringComparison.Ordinal)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny(this string? value, ICollection<char> items,
        StringComparison comparisonType = StringComparison.Ordinal)
    {
        value.ValidateIsNotNull(nameof(value));
        items.ValidateIsNotNull(nameof(items));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny(this string? value,
        StringComparison comparisonType = StringComparison.Ordinal, params char[] items)
    {
        return value.CheckDoesNotContainAny(items, comparisonType);
    }
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAny(this string? value, IEnumerable<char> items,
        StringComparison comparisonType = StringComparison.Ordinal)
    {
        return value.CheckDoesNotContainAny(items.ToList(), comparisonType);
    }
    ...
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAny(this string? value, ICollection<string> items, string variableName,
        StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        if (!value.CheckDoesNotContainAny(items, comparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain any of the specified items.",
                "DoesNotContainAny", blackboard, new Dictionary<string, object?>
                {
                    { "value", value },
                    { "items", items }
                });
    ...
    /// <exception cref="ValidationException">Thrown if the string contains any of the specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAny(this string? value, string variableName,
    ...
    /// <exception cref="ValidationException">Thrown if the string contains any of the specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAny(this string? value, IEnumerable<string> items, string variableName,
        StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
    ...
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAny(this string? value, ICollection<char> items, string variableName,
        StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        if (!value.CheckDoesNotContainAny(items, comparisonType))
        {
            throw new ValidationException(variableName,
                $"{variableName} must not contain any of the specified characters.", "DoesNotContainAny", blackboard,
    ...
    /// <exception cref="ValidationException">Thrown if the string contains any of the specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAny(this string? value, IEnumerable<char> items, string variableName,
        StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        return value.ValidateDoesNotContainAny(items.ToList(), variableName, comparisonType, blackboard);
    }
