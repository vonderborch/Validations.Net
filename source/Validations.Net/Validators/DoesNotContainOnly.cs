...
public static class DoesNotContainOnly
{
    ...
    {
        return !value.CheckDoesContainOnly(items);
    }
    ...
    public static void EnsureDoesNotContainOnly<T>(this IEnumerable<T>? value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName,
                $"The collection must not contain only the specified items: [{string.Join(", ", items ?? Array.Empty<T>())}]",
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection contains only the specified items.</exception>
    public static void EnsureDoesNotContainOnly<T>(this IList<T>? value, string fieldName, IBlackboard? blackboard,
        params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection contains only the specified items.</exception>
    public static void EnsureDoesNotContainOnly<T>(this List<T>? value, string fieldName, IBlackboard? blackboard,
        params T?[] items)
    {
        EnsureDoesNotContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection contains only the specified items.</exception>
    public static void EnsureDoesNotContainOnly<T>(this T[]? value, string fieldName, IBlackboard? blackboard,
        params T?[] items)
    {
        EnsureDoesNotContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection contains only the specified items.</exception>
    public static void EnsureDoesNotContainOnly<T>(this ReadOnlySpan<T> value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection contains only the specified items.</exception>
    public static void EnsureDoesNotContainOnly<T>(this Span<T> value, string fieldName, IBlackboard? blackboard,
        params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection contains only the specified items.</exception>
    public static void EnsureDoesNotContainOnly<T>(this Memory<T> value, string fieldName, IBlackboard? blackboard,
        params T?[] items)
    {
    ...
    public static ValidationResult ValidateDoesNotContainOnly<T>(this IEnumerable<T>? value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
        var isValid = CheckDoesNotContainOnly(value, items);
        var contextList = new List<(string, object?)>
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesNotContainOnly<T>(this IList<T>? value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesNotContainOnly<T>(this List<T>? value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
        return ValidateDoesNotContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesNotContainOnly<T>(this T[]? value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
        return ValidateDoesNotContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesNotContainOnly<T>(this ReadOnlySpan<T> value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesNotContainOnly<T>(this Span<T> value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesNotContainOnly<T>(this Memory<T> value, string fieldName,
        IBlackboard? blackboard, params T?[] items)
    {
