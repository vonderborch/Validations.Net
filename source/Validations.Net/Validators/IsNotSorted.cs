...
public static class IsNotSorted
{
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IComparable<T>
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName, "Collection must not be sorted in ascending order.",
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IComparable<T>
    {
        ...
        var orderText = ascending ? "ascending" : "descending";
        return ValidationResult.CreateFromValidationFailure(ValidatorName, $"Collection must not be sorted in {orderText} order.",
            parameterName, blackboard, contextList);
    }
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IComparable<T>
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName, "Array must not be sorted in ascending order.",
            parameterName, blackboard, contextList);
    }
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IComparable<T>
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName, "List must not be sorted in ascending order.",
            parameterName, blackboard, contextList);
    }
}
