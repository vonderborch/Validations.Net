...
public static class IsNotSorted
{
    ...
    {
        return !value.CheckIsSorted(ascending);
    }
    ...
    {
        return !value.CheckIsSorted(comparer);
    }
    ...
    public static void EnsureIsNotSorted<T>(this IEnumerable<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Collection must NOT be sorted in ascending order.",
                fieldName, blackboard, contextList);
        }
    }

    /// <summary>
    ///     Ensures that the specified collection is NOT sorted in the specified order, throwing a ValidationException if it
    ///     is.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <param name="value">The collection to validate.</param>
    ...
    public static void EnsureIsNotSorted<T>(this IEnumerable<T>? value, bool ascending, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, $"Collection must NOT be sorted in {orderText} order.",
                fieldName, blackboard, contextList);
        }
    }
    ...
    public static void EnsureIsNotSorted<T>(this T[]? value, string? fieldName = null, IBlackboard? blackboard = null)
        where T : IComparable<T>
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Array must NOT be sorted in ascending order.", fieldName,
    ...
    public static void EnsureIsNotSorted<T>(this IList<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsNotSorted(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "List must NOT be sorted in ascending order.", fieldName,
                blackboard, contextList);
        }
    }
    ...
    public static ValidationResult ValidateIsNotSorted<T>(this IEnumerable<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsNotSorted(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "Collection must NOT be sorted in ascending order.", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsNotSorted<T>(this IEnumerable<T>? value, bool ascending,
        string? fieldName = null, IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsNotSorted(value, ascending);
        var contextList = new List<(string, object?)>
        {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                $"Collection must NOT be sorted in {orderText} order.", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsNotSorted<T>(this T[]? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsNotSorted(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "Array must NOT be sorted in ascending order.", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsNotSorted<T>(this IList<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsNotSorted(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "List must NOT be sorted in ascending order.",
                fieldName, blackboard, contextList);
    }
}
