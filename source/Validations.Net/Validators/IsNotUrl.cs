...
public static class IsNotUrl
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsNotUrl(this string? value, IBlackboard? blackboard = null,
    ...
    /// <returns>A ValidationResult indicating whether the string is not a valid URL.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsNotUrl(this string? value, UriKind uriKind, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? fieldName = null)
    {
    ...
    /// <returns>A ValidationResult indicating whether the string is not a valid URL.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsNotUrl(this string? value, string pattern, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? fieldName = null)
    {
    ...
    public static string? EnsureIsNotUrl(this string? value)
    {
        if (!CheckIsNotUrl(value))
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid URL.", null, null,
                contextList);
        }
    ...
    public static string? EnsureIsNotUrl(this string? value, UriKind uriKind)
    {
        if (!CheckIsNotUrl(value, uriKind))
        {
            ...
            throw ValidationException.Create(ValidatorName,
                $"The value must not be a valid URL with URI kind {uriKind}.", null, null, contextList);
        }
    ...
    public static string? EnsureIsNotUrl(this string? value, string pattern)
    {
        if (!CheckIsNotUrl(value, pattern))
        {
            ...
            throw ValidationException.Create(ValidatorName,
                $"The value must not be a valid URL according to pattern '{pattern}'.", null, null, contextList);
        }
