...
public static class IsValidIpAddress
{
    ...
    public static void EnsureIsValidIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid IP address", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsValidIPv4Address(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid IPv4 address", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsValidIPv6Address(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid IPv6 address", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsValidLoopbackIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid loopback IP address", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsValidPrivateIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid private IP address", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsValidPublicIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid public IP address", null, null,
                contextList);
        }
    }
    ...
    public static ValidationResult ValidateIsValidIpAddress(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid IP address",
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidIPv4Address(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsValidIPv4Address(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid IPv4 address",
                fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidIPv6Address(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsValidIPv6Address(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid IPv6 address",
                fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidLoopbackIpAddress(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsValidLoopbackIpAddress(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must be a valid loopback IP address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidPrivateIpAddress(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsValidPrivateIpAddress(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must be a valid private IP address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidPublicIpAddress(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsValidPublicIpAddress(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid public IP address",
                fieldName, blackboard, contextList);
    }
}
