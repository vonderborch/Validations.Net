...
public static class IsBusinessDay
{
    ...
    public static ValidationResult ValidateIsBusinessDay(this DateTime value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "Value must fall on a business day (Monday through Friday).", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value falls on a business day.</returns>
    public static ValidationResult ValidateIsBusinessDay(this DateTimeOffset value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsBusinessDay(value);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <summary>
    /// Validates if the specified DateTime value falls on a business day, excluding specified holidays, and returns a ValidationResult.
    /// </summary>
    /// <param name="value">The DateTime value to validate.</param>
    /// <param name="holidays">An array of holiday dates to exclude from business days.</param>
    /// <param name="fieldName">The name of the field being validated.</param>
    ...
    public static ValidationResult ValidateIsBusinessDay(this DateTime value, DateTime[] holidays, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "Value must fall on a business day (Monday through Friday) and not be a holiday.", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsBusinessDay(this DateTime value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsBusinessDay(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Value must fall on a business day (Monday through Friday).", fieldName, blackboard, contextList);
        }
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value does not fall on a business day.</exception>
    public static void EnsureIsBusinessDay(this DateTimeOffset value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsBusinessDay(value);
        if (!isValid)
        {
    ...
    public static void EnsureIsBusinessDay(this DateTime value, DateTime[] holidays, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsBusinessDay(value, holidays);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Value must fall on a business day (Monday through Friday) and not be a holiday.", fieldName, blackboard, contextList);
        }
    }
}
