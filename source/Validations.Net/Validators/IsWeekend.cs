...
public static class IsWeekend
{
    ...
    public static ValidationResult ValidateIsWeekend(this DateTime value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "Value must fall on a weekend (Saturday or Sunday).", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value falls on a weekend.</returns>
    public static ValidationResult ValidateIsWeekend(this DateTimeOffset value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsWeekend(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsWeekend(this DateTime value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Value must fall on a weekend (Saturday or Sunday).", fieldName, blackboard, contextList);
        }
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value does not fall on a weekend.</exception>
    public static void EnsureIsWeekend(this DateTimeOffset value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsWeekend(value);
        if (!isValid)
        {
