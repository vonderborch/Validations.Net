...
public static class DoesContain
{
    ...
    public static string? EnsureDoesContain(this string? value, string? substring, IBlackboard? blackboard = null,
    ...
    /// <returns>The original string if it contains the substring.</returns>
    /// <exception cref="ValidationException">Thrown when the string does not contain the substring.</exception>
    public static string? EnsureDoesContain(this string? value, string? substring, StringComparison comparisonType,
    ...
    public static IEnumerable<T>? EnsureDoesContain<T>(this IEnumerable<T>? value, T? item,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    /// <returns>The original collection if it contains the item.</returns>
    /// <exception cref="ValidationException">Thrown when the collection does not contain the item.</exception>
    public static IEnumerable? EnsureDoesContain(this IEnumerable? value, object? item, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContain(item, blackboard, parameterName);
        if (!result.IsValid)
    ...
    public static ReadOnlySpan<T> EnsureDoesContain<T>(this ReadOnlySpan<T> value, T? item,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    ...
    /// <returns>The original span if it contains the item.</returns>
    /// <exception cref="ValidationException">Thrown when the span does not contain the item.</exception>
    public static Span<T> EnsureDoesContain<T>(this Span<T> value, T? item, IBlackboard? blackboard = null,
    ...
    public static Memory<T> EnsureDoesContain<T>(this Memory<T> value, T? item, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IEquatable<T>
    {
        var result = value.ValidateDoesContain(item, blackboard, parameterName);
        if (!result.IsValid)
    ...
    public static StringBuilder? EnsureDoesContain(this StringBuilder? value, string? substring,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContain(substring, blackboard, parameterName);
        if (!result.IsValid)
    ...
    public static ValidationResult ValidateDoesContain(this string? value, string? substring,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "String does not contain the specified substring.", parameterName, blackboard, context);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContain<T>(this IEnumerable<T>? value, T? item,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "Collection does not contain the specified item.", parameterName, blackboard, context);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContain(this IEnumerable? value, object? item,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (value.CheckDoesContain(item))
        {
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContain<T>(this ReadOnlySpan<T> value, T? item,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
        where T : IEquatable<T>
    {
        if (value.CheckDoesContain(item))
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName, "Span does not contain the specified item.",
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContain<T>(this Span<T> value, T? item, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IEquatable<T>
    {
        if (value.CheckDoesContain(item))
        {
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContain<T>(this Memory<T> value, T? item, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IEquatable<T>
    {
        if (value.CheckDoesContain(item))
        {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "Memory does not contain the specified item.", parameterName, blackboard, context);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContain(this StringBuilder? value, string? substring,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (value.CheckDoesContain(substring))
        {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "StringBuilder does not contain the specified substring.", parameterName, blackboard, context);
    }
