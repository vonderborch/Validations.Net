...
public static class DoesContain
{
    ...
    {
        var result = value.ValidateDoesContain(substring, blackboard, validationFailureMessage, parameterName);
        if (!result.IsValid)
        {
    ...
    public static string? EnsureDoesContain(this string? value, string? substring, StringComparison comparisonType,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContain(substring, comparisonType, blackboard, validationFailureMessage, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static IEnumerable<T>? EnsureDoesContain<T>(this IEnumerable<T>? value, T? item,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContain(item, blackboard, validationFailureMessage, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
