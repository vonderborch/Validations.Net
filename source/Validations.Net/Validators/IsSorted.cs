...
public static class IsSorted
{
    ...
    public static void EnsureIsSorted<T>(this IEnumerable<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Collection must be sorted in ascending order.", fieldName,
                blackboard, contextList);
        }
    }

    /// <summary>
    ///     Ensures that the specified collection is sorted in the specified order, throwing a ValidationException if it is
    ///     not.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <param name="value">The collection to validate.</param>
    ...
    public static void EnsureIsSorted<T>(this IEnumerable<T>? value, bool ascending, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, $"Collection must be sorted in {orderText} order.",
    ...
    public static void EnsureIsSorted<T>(this T[]? value, string? fieldName = null, IBlackboard? blackboard = null)
        where T : IComparable<T>
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Array must be sorted in ascending order.", fieldName,
                blackboard, contextList);
        }
    }
    ...
    public static void EnsureIsSorted<T>(this IList<T>? value, string? fieldName = null, IBlackboard? blackboard = null)
        where T : IComparable<T>
    {
        var isValid = CheckIsSorted(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "List must be sorted in ascending order.", fieldName,
                blackboard, contextList);
        }
    }
    ...
    public static ValidationResult ValidateIsSorted<T>(this IEnumerable<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsSorted(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "Collection must be sorted in ascending order.", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsSorted<T>(this IEnumerable<T>? value, bool ascending,
        string? fieldName = null, IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                $"Collection must be sorted in {orderText} order.", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsSorted<T>(this T[]? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsSorted(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "Array must be sorted in ascending order.",
                fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsSorted<T>(this IList<T>? value, string? fieldName = null,
        IBlackboard? blackboard = null) where T : IComparable<T>
    {
        var isValid = CheckIsSorted(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "List must be sorted in ascending order.",
                fieldName, blackboard, contextList);
    }
}
