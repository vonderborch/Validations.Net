...
public static class IsNotDivisibleBy
{
    ...
    public static void EnsureIsNotDivisibleBy(this int value, int divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, $"Value must NOT be divisible by {divisor}.", fieldName,
                blackboard, contextList);
        }
    }

    /// <summary>
    ///     Ensures that the specified nullable integer value is NOT divisible by the divisor, throwing a ValidationException
    ///     if it is.
    /// </summary>
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is divisible by the divisor.</exception>
    public static void EnsureIsNotDivisibleBy(this long value, long divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        if (!isValid)
    ...
    /// <summary>
    ///     Ensures that the specified nullable long value is NOT divisible by the divisor, throwing a ValidationException if
    ///     it is.
    /// </summary>
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is divisible by the divisor.</exception>
    public static void EnsureIsNotDivisibleBy(this short value, short divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        if (!isValid)
    ...
    /// <summary>
    ///     Ensures that the specified nullable short value is NOT divisible by the divisor, throwing a ValidationException if
    ///     it is.
    /// </summary>
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is divisible by the divisor.</exception>
    public static void EnsureIsNotDivisibleBy(this byte value, byte divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        if (!isValid)
    ...
    /// <summary>
    ///     Ensures that the specified nullable byte value is NOT divisible by the divisor, throwing a ValidationException if
    ///     it is.
    /// </summary>
    ...
    public static ValidationResult ValidateIsNotDivisibleBy(this int value, int divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, $"Value must NOT be divisible by {divisor}.",
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is NOT divisible by the divisor.</returns>
    public static ValidationResult ValidateIsNotDivisibleBy(this long value, long divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is NOT divisible by the divisor.</returns>
    public static ValidationResult ValidateIsNotDivisibleBy(this short value, short divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is NOT divisible by the divisor.</returns>
    public static ValidationResult ValidateIsNotDivisibleBy(this byte value, byte divisor, string? fieldName = null,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
