...
public static class IsLessThan
{
    ...
    public static T EnsureIsLessThan<T>(this T value, T other, string? parameterName = null, IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ValidationResult result = value.ValidateIsLessThan(other, parameterName, blackboard);
        if (!result.IsValid)
        {
    ...
    public static ValidationResult ValidateIsLessThan<T>(this T value, T other, string? parameterName = null, IBlackboard? blackboard = null) where T : IComparable<T>
    {
