...
public static class DoesContainAny
{
    ...
    public static string? EnsureDoesContainAny(this string? value, IBlackboard? blackboard = null,
        ...
        params string?[] substrings)
    {
        var result = value.ValidateDoesContainAny(blackboard, validationFailureMessage, parameterName, substrings);
        if (!result.IsValid)
        {
    ...
    public static string? EnsureDoesContainAny(this string? value, IList<string?> substrings,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContainAny(substrings, blackboard, validationFailureMessage, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static string? EnsureDoesContainAny(this string? value, StringComparison comparison,
        ...
        params string?[] substrings)
    {
        var result = value.ValidateDoesContainAny(comparison, blackboard, validationFailureMessage, parameterName, substrings);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static string? EnsureDoesContainAny(this string? value, IList<string?> substrings,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContainAny(substrings, comparison, blackboard, validationFailureMessage, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static IEnumerable<T>? EnsureDoesContainAny<T>(this IEnumerable<T>? value, IBlackboard? blackboard = null,
        ...
        params T?[] items)
    {
        var result = value.ValidateDoesContainAny(blackboard, validationFailureMessage, parameterName, items);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static IEnumerable<T>? EnsureDoesContainAny<T>(this IEnumerable<T>? value, IList<T?> items,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContainAny(items, blackboard, validationFailureMessage, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
