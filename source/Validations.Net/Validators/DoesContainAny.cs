...
public static class DoesContainAny
{
    ...
    /// <returns>True if the string contains any of the substrings; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesContainAny(this string? value, StringComparison comparisonType,
    ...
    public static ValidationResult ValidateDoesContainAny(this string? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params string?[] substrings)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            $"String '{value}' does not contain any of the specified substrings.", parameterName, blackboard,
            contextList);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny(this string? value, IList<string?> substrings,
    ...
    /// <param name="substrings">The substrings to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny(this string? value, StringComparison comparison,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null,
        params string?[] substrings)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            $"String '{value}' does not contain any of the specified substrings using comparison '{comparison}'.",
    ...
    /// <param name="items">The items to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this IEnumerable<T>? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "Collection does not contain any of the specified items.", parameterName, blackboard, contextList);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this IEnumerable<T>? value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (value.CheckDoesContainAny(items))
        {
    ...
    /// <param name="items">The items to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny(this IEnumerable? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params object?[] items)
    {
        if (value.CheckDoesContainAny(items))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny(this IEnumerable? value, IList<object?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (value.CheckDoesContainAny(items))
        {
    ...
    /// <param name="items">The items to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this ReadOnlySpan<T> value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
        where T : IEquatable<T>
    {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "Span does not contain any of the specified items.", parameterName, blackboard, contextList);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this ReadOnlySpan<T> value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
        where T : IEquatable<T>
    {
        if (value.CheckDoesContainAny(items))
    ...
    /// <param name="items">The items to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this Span<T> value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
        where T : IEquatable<T>
    {
        if (value.CheckDoesContainAny(items))
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this Span<T> value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
        where T : IEquatable<T>
    {
        if (value.CheckDoesContainAny(items))
    ...
    /// <param name="items">The items to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this Memory<T> value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
        where T : IEquatable<T>
    {
        if (value.CheckDoesContainAny(items))
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "Memory does not contain any of the specified items.", parameterName, blackboard, contextList);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny<T>(this Memory<T> value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
        where T : IEquatable<T>
    {
        if (value.CheckDoesContainAny(items))
    ...
    /// <param name="substrings">The substrings to search for.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny(this StringBuilder? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params string?[] substrings)
    {
        if (value.CheckDoesContainAny(substrings))
        {
        ...
        return ValidationResult.CreateFromValidationFailure(ValidatorName,
            "StringBuilder does not contain any of the specified substrings.", parameterName, blackboard, contextList);
    }
    ...
    /// <param name="parameterName">The name of the parameter being validated.</param>
    /// <returns>A ValidationResult indicating whether the validation passed.</returns>
    public static ValidationResult ValidateDoesContainAny(this StringBuilder? value, IList<string?> substrings,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (value.CheckDoesContainAny(substrings))
        {
    ...
    public static string? EnsureDoesContainAny(this string? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params string?[] substrings)
    {
    ...
    /// <returns>The original string if it contains any of the substrings.</returns>
    /// <exception cref="ValidationException">Thrown when the string does not contain any of the substrings.</exception>
    public static string? EnsureDoesContainAny(this string? value, IList<string?> substrings,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    /// <returns>The original string if it contains any of the substrings.</returns>
    /// <exception cref="ValidationException">Thrown when the string does not contain any of the substrings.</exception>
    public static string? EnsureDoesContainAny(this string? value, StringComparison comparison,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null,
        params string?[] substrings)
    {
    ...
    public static IEnumerable<T>? EnsureDoesContainAny<T>(this IEnumerable<T>? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
    {
    ...
    /// <returns>The original collection if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the items.</exception>
    public static IEnumerable<T>? EnsureDoesContainAny<T>(this IEnumerable<T>? value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    /// <returns>The original collection if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the items.</exception>
    public static IEnumerable? EnsureDoesContainAny(this IEnumerable? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params object?[] items)
    {
        var result = value.ValidateDoesContainAny(blackboard, parameterName, items);
        if (!result.IsValid)
    ...
    /// <returns>The original collection if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the collection does not contain any of the items.</exception>
    public static IEnumerable? EnsureDoesContainAny(this IEnumerable? value, IList<object?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContainAny(items, blackboard, parameterName);
        if (!result.IsValid)
    ...
    public static ReadOnlySpan<T> EnsureDoesContainAny<T>(this ReadOnlySpan<T> value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
        where T : IEquatable<T>
    {
        var result = value.ValidateDoesContainAny(blackboard, parameterName, items);
    ...
    /// <returns>The original span if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the span does not contain any of the items.</exception>
    public static ReadOnlySpan<T> EnsureDoesContainAny<T>(this ReadOnlySpan<T> value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
        where T : IEquatable<T>
    {
        var result = value.ValidateDoesContainAny(items, blackboard, parameterName);
    ...
    /// <returns>The original span if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the span does not contain any of the items.</exception>
    public static Span<T> EnsureDoesContainAny<T>(this Span<T> value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
        where T : IEquatable<T>
    {
        var result = value.ValidateDoesContainAny(blackboard, parameterName, items);
    ...
    /// <returns>The original span if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the span does not contain any of the items.</exception>
    public static Span<T> EnsureDoesContainAny<T>(this Span<T> value, IList<T?> items, IBlackboard? blackboard = null,
    ...
    public static Memory<T> EnsureDoesContainAny<T>(this Memory<T> value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params T?[] items)
        where T : IEquatable<T>
    {
        var result = value.ValidateDoesContainAny(blackboard, parameterName, items);
    ...
    /// <returns>The original memory if it contains any of the items.</returns>
    /// <exception cref="ValidationException">Thrown when the memory does not contain any of the items.</exception>
    public static Memory<T> EnsureDoesContainAny<T>(this Memory<T> value, IList<T?> items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
        where T : IEquatable<T>
    {
        var result = value.ValidateDoesContainAny(items, blackboard, parameterName);
    ...
    public static StringBuilder? EnsureDoesContainAny(this StringBuilder? value, IBlackboard? blackboard = null,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null, params string?[] substrings)
    {
        var result = value.ValidateDoesContainAny(blackboard, parameterName, substrings);
        if (!result.IsValid)
    ...
    /// <returns>The original StringBuilder if it contains any of the substrings.</returns>
    /// <exception cref="ValidationException">Thrown when the StringBuilder does not contain any of the substrings.</exception>
    public static StringBuilder? EnsureDoesContainAny(this StringBuilder? value, IList<string?> substrings,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = value.ValidateDoesContainAny(substrings, blackboard, parameterName);
        if (!result.IsValid)
