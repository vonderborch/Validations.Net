...
public static class DoesContainAny
{
    ...
    public static string ValidateDoesContainAny(this string? value, ICollection<string> subStrings,
        ...
        StringComparison comparison = StringComparison.Ordinal, Blackboard? blackboard = null)
    {
        ...
        {
            throw new ValidationException("DoesContainAny", parameterName,
                $"{parameterName} must contain any of the substrings.", blackboard, new Dictionary<string, object?>
                {
                    { "value", value },
        ...
        StringComparison comparison = StringComparison.Ordinal, Blackboard? blackboard = null)
    {
        ...
        {
            throw new ValidationException("DoesContainAny", parameterName,
                $"{parameterName} must contain any of the characters.", blackboard, new Dictionary<string, object?>
                {
                    { "value", value },
    ...
    public static ICollection<T> ValidateDoesContainAny<T>(this ICollection<T>? collection, ICollection<T> items,
        string parameterName,
        Blackboard? blackboard = null)
    {
        ...
        {
            throw new ValidationException("DoesContainAny", parameterName,
                $"{parameterName} must contain any of the items.", blackboard, new Dictionary<string, object?>
                {
    ...
    public static ICollection<T> ValidateDoesContainAny<T>(this ICollection<T>? collection,
        ...
        Blackboard? blackboard = null)
    {
        ...
        {
            throw new ValidationException("DoesContainAny", parameterName,
                $"{parameterName} must contain at least one item matching any of the predicates.", blackboard,
