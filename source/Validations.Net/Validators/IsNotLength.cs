...
public static class IsNotLength
{
    ...
    /// <summary>
    /// Validates that a collection does not have the specified length, throwing a <see cref="ValidationException"/> if it does.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    ...
    /// <summary>
    /// Validates that a string does not have the specified length, throwing a <see cref="ValidationException"/> if it does.
    /// </summary>
