...
public static class IsPostalCode
{
    ...
    public static bool CheckIsPostalCode(this string? value, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
    ...
    public static ValidationResult ValidateIsPostalCode(this string? value, string fieldName, IBlackboard? blackboard, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid postal code", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsUsZipCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid US ZIP code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsCanadianPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid Canadian postal code", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsUkPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid UK postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsGermanPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid German postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsFrenchPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid French postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsJapanesePostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid Japanese postal code", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsPostalCode(this string? value, string fieldName, IBlackboard? blackboard, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        var isValid = CheckIsPostalCode(value, pattern, options);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid postal code", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsUsZipCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid US ZIP code", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsCanadianPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid Canadian postal code", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsUkPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid UK postal code", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsGermanPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid German postal code", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsFrenchPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid French postal code", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsJapanesePostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid Japanese postal code", null, null, contextList);
        }
    }
}
