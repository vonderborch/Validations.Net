...
public static class IsNotCreditCard
{
    ...
    {
        return !value.CheckIsAmericanExpress(validateLuhn);
    }
    ...
    {
        return !value.CheckIsCreditCard(validateLuhn);
    }
    ...
    {
        return !value.CheckIsMasterCard(validateLuhn);
    }
    ...
    {
        return !value.CheckIsVisaCard(validateLuhn);
    }
    ...
    public static void EnsureIsNotAmericanExpress(this string? value, string fieldName, IBlackboard? blackboard,
        bool validateLuhn = true)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName,
                "The value must not be a valid American Express card number", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotCreditCard(this string? value, string fieldName, IBlackboard? blackboard,
        bool validateLuhn = true)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid credit card number", null,
                null, contextList);
        }
    }
    ...
    public static void EnsureIsNotMasterCard(this string? value, string fieldName, IBlackboard? blackboard,
        bool validateLuhn = true)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid MasterCard number", null,
                null, contextList);
        }
    }
    ...
    public static void EnsureIsNotVisaCard(this string? value, string fieldName, IBlackboard? blackboard,
        bool validateLuhn = true)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid Visa card number", null,
                null, contextList);
        }
    }
    ...
    public static ValidationResult ValidateIsNotAmericanExpress(this string? value, string fieldName,
        IBlackboard? blackboard, bool validateLuhn = true)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid American Express card number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="validateLuhn">Whether to validate using the Luhn algorithm. Default is true.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotCreditCard(this string? value, string fieldName,
        IBlackboard? blackboard, bool validateLuhn = true)
    {
        var isValid = CheckIsNotCreditCard(value, validateLuhn);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid credit card number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="validateLuhn">Whether to validate using the Luhn algorithm. Default is true.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotMasterCard(this string? value, string fieldName,
        IBlackboard? blackboard, bool validateLuhn = true)
    {
        var isValid = CheckIsNotMasterCard(value, validateLuhn);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid MasterCard number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="validateLuhn">Whether to validate using the Luhn algorithm. Default is true.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotVisaCard(this string? value, string fieldName, IBlackboard? blackboard,
        bool validateLuhn = true)
    {
        var isValid = CheckIsNotVisaCard(value, validateLuhn);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid Visa card number", fieldName, blackboard, contextList);
    }
}
