...
public static class IsNotValidBase64
{
    ...
    public static ValidationResult ValidateIsNotValidBase64(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidBase64WithPadding(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidBase64WithoutPadding(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidBase64WithLength(string? value, int expectedLength, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidBase64WithMinimumLength(string? value, int minimumLength, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static void EnsureIsNotValidBase64WithPadding(string? value, string fieldName, IBlackboard? blackboard = null)
    {
        var isNotValid = CheckIsNotValidBase64WithPadding(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsNotValidBase64WithoutPadding(string? value, string fieldName, IBlackboard? blackboard = null)
    {
        var isNotValid = CheckIsNotValidBase64WithoutPadding(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsNotValidBase64WithLength(string? value, int expectedLength, string fieldName, IBlackboard? blackboard = null)
    {
        var isNotValid = CheckIsNotValidBase64WithLength(value, expectedLength);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsNotValidBase64WithMinimumLength(string? value, int minimumLength, string fieldName, IBlackboard? blackboard = null)
    {
        var isNotValid = CheckIsNotValidBase64WithMinimumLength(value, minimumLength);
        var contextList = new List<(string, object?)>
        {
