...
public static class IsPalindrome
{
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the string is a palindrome.</returns>
    public static ValidationResult ValidateIsPalindrome(string? value, StringComparison comparison, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the string is a palindrome.</returns>
    public static ValidationResult ValidateIsPalindromeCaseSensitive(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the string is a palindrome.</returns>
    public static ValidationResult ValidateIsPalindromeCaseInsensitive(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the string is a palindrome.</returns>
    public static ValidationResult ValidateIsPalindromeIgnoreSpacesAndPunctuation(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the string is not a palindrome.</exception>
    public static void EnsureIsPalindrome(string? value, StringComparison comparison, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsPalindrome(value, comparison);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the string is not a palindrome.</exception>
    public static void EnsureIsPalindromeCaseInsensitive(string? value, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsPalindromeCaseInsensitive(value);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the string is not a palindrome.</exception>
    public static void EnsureIsPalindromeIgnoreSpacesAndPunctuation(string? value, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsPalindromeIgnoreSpacesAndPunctuation(value);
        var contextList = new List<(string, object?)>
        {
    ...
    private static string NormalizeString(string value, StringComparison comparison = StringComparison.OrdinalIgnoreCase)
    {
