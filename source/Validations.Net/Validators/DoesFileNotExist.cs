...
public static class DoesFileNotExist
{
    ...
    public static ValidationResult ValidateDoesFileNotExist(this string? filePath, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The file must not exist", fieldName, blackboard, contextList);
    }
