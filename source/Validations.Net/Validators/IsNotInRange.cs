...
public static class IsNotInRange
{
    ...
    /// </summary>
    public const string DefaultValidationFailureMessage = "Parameter must not be within the specified range";
        ...
        where T : IComparable<T>
    {
        var validationResult =
            value.ValidateIsNotInRange(minimum, maximum, minimumInclusive, maximumInclusive, blackboard, validationFailureMessage, parameterName);
