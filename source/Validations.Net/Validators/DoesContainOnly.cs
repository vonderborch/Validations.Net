...
public static class DoesContainOnly
{
    ...
    public static bool CheckDoesContainOnly<T>(this IEnumerable<T>? value, params T?[] items)
    {
        ...
        if (items == null || items.Length == 0) return !value.Any();
    ...
    public static ValidationResult ValidateDoesContainOnly<T>(this IEnumerable<T>? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, $"The collection must contain only the specified items: [{string.Join(", ", items ?? Array.Empty<T>())}]", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesContainOnly<T>(this IList<T>? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesContainOnly<T>(this List<T>? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
        return ValidateDoesContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesContainOnly<T>(this T[]? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
        return ValidateDoesContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesContainOnly<T>(this ReadOnlySpan<T> value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesContainOnly<T>(this Span<T> value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateDoesContainOnly<T>(this Memory<T> value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    public static void EnsureDoesContainOnly<T>(this IEnumerable<T>? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
        var isValid = CheckDoesContainOnly(value, items);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, $"The collection must contain only the specified items: [{string.Join(", ", items ?? Array.Empty<T>())}]", null, null, contextList);
        }
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection does not contain only the specified items.</exception>
    public static void EnsureDoesContainOnly<T>(this IList<T>? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection does not contain only the specified items.</exception>
    public static void EnsureDoesContainOnly<T>(this List<T>? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
        EnsureDoesContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection does not contain only the specified items.</exception>
    public static void EnsureDoesContainOnly<T>(this T[]? value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
        EnsureDoesContainOnly((IEnumerable<T>?)value, fieldName, blackboard, items);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection does not contain only the specified items.</exception>
    public static void EnsureDoesContainOnly<T>(this ReadOnlySpan<T> value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection does not contain only the specified items.</exception>
    public static void EnsureDoesContainOnly<T>(this Span<T> value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the collection does not contain only the specified items.</exception>
    public static void EnsureDoesContainOnly<T>(this Memory<T> value, string fieldName, IBlackboard? blackboard, params T?[] items)
    {
