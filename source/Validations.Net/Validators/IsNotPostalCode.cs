...
public static class IsNotPostalCode
{
    ...
    {
        return !value.CheckIsCanadianPostalCode();
    }
    ...
    {
        return !value.CheckIsFrenchPostalCode();
    }
    ...
    {
        return !value.CheckIsGermanPostalCode();
    }
    ...
    {
        return !value.CheckIsJapanesePostalCode();
    }
    ...
    public static bool CheckIsNotPostalCode(this string? value, string? pattern = null,
        RegexOptions options = RegexOptions.None)
    {
        return !value.CheckIsPostalCode(pattern, options);
    }
    ...
    {
        return !value.CheckIsUkPostalCode();
    }
    ...
    public static void EnsureIsNotCanadianPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid Canadian postal code", null,
                null, contextList);
        }
    }
    ...
    public static void EnsureIsNotFrenchPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid French postal code", null,
                null, contextList);
        }
    }
    ...
    public static void EnsureIsNotGermanPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid German postal code", null,
                null, contextList);
        }
    }
    ...
    public static void EnsureIsNotJapanesePostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid Japanese postal code", null,
                null, contextList);
        }
    }
    ...
    public static void EnsureIsNotPostalCode(this string? value, string fieldName, IBlackboard? blackboard,
        string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid postal code", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsNotUkPostalCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid UK postal code", null, null,
                contextList);
        }
    }
    ...
    public static void EnsureIsNotUsZipCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid US ZIP code", null, null,
                contextList);
        }
    }
    ...
    public static ValidationResult ValidateIsNotCanadianPostalCode(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid Canadian postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotFrenchPostalCode(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsNotFrenchPostalCode(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid French postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotGermanPostalCode(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsNotGermanPostalCode(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid German postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotJapanesePostalCode(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsNotJapanesePostalCode(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid Japanese postal code", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="options">Regex options to use.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotPostalCode(this string? value, string fieldName,
        IBlackboard? blackboard, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid postal code",
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotUkPostalCode(this string? value, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckIsNotUkPostalCode(value);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName,
                "The value must not be a valid UK postal code", fieldName, blackboard, contextList);
    }
    ...
    public static ValidationResult ValidateIsNotUsZipCode(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid US ZIP code",
                fieldName, blackboard, contextList);
    }
}
