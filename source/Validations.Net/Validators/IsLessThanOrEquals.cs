...
public static class IsLessThanOrEquals
{
    ...
    public static T EnsureIsLessThanOrEquals<T>(this T value, T other, string? parameterName = null, IBlackboard? blackboard = null) where T : IComparable<T>
    {
        ValidationResult result = value.ValidateIsLessThanOrEquals(other, parameterName, blackboard);
        if (!result.IsValid)
        {
    ...
    public static ValidationResult ValidateIsLessThanOrEquals<T>(this T value, T other, string? parameterName = null, IBlackboard? blackboard = null) where T : IComparable<T>
    {
