...
public static class IsInPast
{
    ...
    public static ValidationResult ValidateIsInPast(this DateTime value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "Value must be in the past.", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is in the past.</returns>
    public static ValidationResult ValidateIsInPast(this DateTimeOffset value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsInPast(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsInPast(this DateTime value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Value must be in the past.", fieldName, blackboard, contextList);
        }
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is not in the past.</exception>
    public static void EnsureIsInPast(this DateTimeOffset value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsInPast(value);
        if (!isValid)
        {
