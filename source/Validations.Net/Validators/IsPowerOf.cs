...
public static class IsPowerOf
{
    ...
    public static ValidationResult ValidateIsPowerOf(int value, int @base, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the value is a power of the base.</returns>
    public static ValidationResult ValidateIsPowerOf(long value, long @base, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsPowerOf(value, @base);
        var contextList = new List<(string, object?)>
        {
