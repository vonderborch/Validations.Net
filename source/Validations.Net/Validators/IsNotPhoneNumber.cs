...
public static class IsNotPhoneNumber
{
    ...
    public static bool CheckIsNotPhoneNumber(this string? value, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        return !IsPhoneNumber.CheckIsPhoneNumber(value, pattern, options);
    }
    ...
    public static ValidationResult ValidateIsNotPhoneNumber(this string? value, string fieldName, IBlackboard? blackboard, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid phone number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotInternationalPhoneNumber(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid international phone number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotNorthAmericanPhoneNumber(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid North American phone number", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsNotPhoneNumber(this string? value, string fieldName, IBlackboard? blackboard, string? pattern = null, RegexOptions options = RegexOptions.None)
    {
        var isValid = CheckIsNotPhoneNumber(value, pattern, options);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid phone number", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotInternationalPhoneNumber(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsNotInternationalPhoneNumber(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid international phone number", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotNorthAmericanPhoneNumber(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsNotNorthAmericanPhoneNumber(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid North American phone number", null, null, contextList);
        }
    }
}
