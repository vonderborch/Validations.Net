...
public static class IsGreaterThan
{
    ...
    public static T EnsureIsGreaterThan<T>(this T value, T other, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IComparable<T>
    {
        ValidationResult result = value.ValidateIsGreaterThan(other, blackboard, parameterName);
        if (!result.IsValid)
        {
    ...
    public static ValidationResult ValidateIsGreaterThan<T>(this T value, T other, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : IComparable<T>
    {
