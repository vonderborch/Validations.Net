...
public static class IsEmail
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsEmail(this string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? fieldName = null)
    {
    ...
    /// <returns>A ValidationResult indicating whether the string is a valid email address.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsEmail(this string? value, string pattern, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? fieldName = null)
    {
    ...
    public static string? EnsureIsEmail(this string? value)
    {
        if (!CheckIsEmail(value))
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value is not a valid email address.", null, null, contextList);
        }
    ...
    public static string? EnsureIsEmail(this string? value, string pattern)
    {
        if (!CheckIsEmail(value, pattern))
        {
            ...
            throw ValidationException.Create(ValidatorName, $"The value is not a valid email address according to pattern '{pattern}'.", null, null, contextList);
        }
