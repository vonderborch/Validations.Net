...
public static class ContainsValidations
{
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContains<T>(this IEnumerable<T> collection, T item, string variableName, object? blackboard = null)
    {
        if (collection == null) throw new ArgumentNullException(nameof(collection));
        
        if (!collection.CheckContains(item))
        {
            throw new ValidationException(variableName, $"{variableName} must contain {item}.", "Contains", blackboard, exceptionContext: new Dictionary<string, object?>
            {
    ...
    /// <exception cref="ValidationException">Thrown when the collection doesn't contain the specified item.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContains<T>(this ICollection<T> collection, T item, string variableName, object? blackboard = null)
    {
        if (collection == null) throw new ArgumentNullException(nameof(collection));
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContains<T>(this IEnumerable<T> collection, Func<T, bool> predicate, string variableName, object? blackboard = null)
    {
        if (collection == null) throw new ArgumentNullException(nameof(collection));
        ...
        {
            throw new ValidationException(variableName, $"{variableName} must contain an item that matches the predicate.", "Contains", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "collection", collection },
                { "predicate", predicate }
            });
    ...
    /// <exception cref="ValidationException">Thrown when no element in the collection matches the predicate.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContains<T>(this ICollection<T> collection, Func<T, bool> predicate, string variableName, object? blackboard = null)
    {
        if (collection == null) throw new ArgumentNullException(nameof(collection));
        if (predicate == null) throw new ArgumentNullException(nameof(predicate));
