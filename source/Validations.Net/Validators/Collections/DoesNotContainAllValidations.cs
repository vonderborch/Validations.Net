...
/// <summary>
/// Provides extension methods for validating that collections do not contain all specific items from another collection.
/// </summary>
/// <remarks>
/// This class contains methods to check if a collection does not contain all items from a specified collection or array,
/// or if it does not contain all items that match a specified predicate. Methods are available for both IEnumerable&lt;T&gt; and ICollection&lt;T&gt;.
/// </remarks>
public static class DoesNotContainAllValidations
{
    ...
    public static bool CheckDoesNotContainAll<T>(this IEnumerable<T> collection, IEnumerable<T> items, IEqualityComparer<T>? comparer = null)
    {
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContainAll<T>(this IEnumerable<T> collection, IEnumerable<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContainAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain all items in the specified collection.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll<T>(this ICollection<T> collection, IEnumerable<T> items, IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains all specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContainAll<T>(this ICollection<T> collection, IEnumerable<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContainAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain all items in the specified collection.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll<T>(this IEnumerable<T> collection, ICollection<T> items, IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains all specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContainAll<T>(this IEnumerable<T> collection, ICollection<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContainAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain all items in the specified collection.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll<T>(this ICollection<T> collection, ICollection<T> items, IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains all specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContainAll<T>(this ICollection<T> collection, ICollection<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContainAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain all items in the specified collection.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll<T>(this IEnumerable<T> collection, IEqualityComparer<T>? comparer = null, params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains all specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContainAll<T>(this IEnumerable<T> collection, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null, params T[] items)
    {
        if (!collection.CheckDoesNotContainAll(comparer, items))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain all specified items.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "collection", collection },
                { "items", items }
            });
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll<T>(this ICollection<T> collection, IEqualityComparer<T>? comparer = null, params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains all specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContainAll<T>(this ICollection<T> collection, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null, params T[] items)
    {
        if (!collection.CheckDoesNotContainAll(comparer, items))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain all specified items.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
