...
/// <summary>
/// Provides extension methods for validating whether collections contain all specified items or match all specified conditions.
/// </summary>
public static class ContainsAllValidations
{
    ...
    public static bool CheckContainsAll<T>(this IEnumerable<T> collection, IEnumerable<T> items, IEqualityComparer<T>? comparer = null)
    {
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAll<T>(this IEnumerable<T> collection, IEnumerable<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all items in the specified collection.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll<T>(this ICollection<T> collection, IEnumerable<T> items, IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain all the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAll<T>(this ICollection<T> collection, IEnumerable<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all items in the specified collection.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll<T>(this IEnumerable<T> collection, ICollection<T> items, IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain all the specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAll<T>(this IEnumerable<T> collection, ICollection<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all items in the specified collection.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll<T>(this ICollection<T> collection, ICollection<T> items, IEqualityComparer<T>? comparer = null)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain all the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAll<T>(this ICollection<T> collection, ICollection<T> items, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null)
    {
        if (!collection.CheckContainsAll(items, comparer))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all items in the specified collection.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll<T>(this IEnumerable<T> collection, IEqualityComparer<T>? comparer = null, params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain all the specified items.</exception>
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateContainsAll<T>(this IEnumerable<T> collection, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null, params T[] items)
    {
        if (!collection.CheckContainsAll(comparer, items))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all specified items.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "collection", collection },
                { "items", items }
            });
    ...
    /// <summary>
    /// Checks if a collection contains all the specified items provided as parameters. Optimized version for ICollection input.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <param name="collection">The collection to check.</param>
    /// <param name="comparer">The equality comparer to use for comparing items, or null to use the default comparer.</param>
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll<T>(this ICollection<T> collection, IEqualityComparer<T>? comparer = null, params T[] items)
    {
        collection.ValidateIsNotNull(nameof(collection));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <summary>
    /// Validates that a collection contains all the specified items provided as parameters. Optimized version for ICollection input.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <param name="collection">The collection to validate.</param>
    /// <param name="variableName">The name of the variable being validated, used in the exception message.</param>
    ...
    /// <exception cref="ValidationException">Thrown when the collection does not contain all the specified items.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateContainsAll<T>(this ICollection<T> collection, string variableName, IEqualityComparer<T>? comparer = null, object? blackboard = null, params T[] items)
    {
        if (!collection.CheckContainsAll(comparer, items))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all specified items.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
        ...
        string variableName, object? blackboard = null)
    {
        ...
        {
            throw new ValidationException(variableName, $"{variableName} must contain all items that match the specified predicate.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "collection", collection },
                { "predicate", predicate }
            });
