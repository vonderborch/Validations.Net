...
/// <summary>
/// Provides extension methods for validating that collections do not contain specific items or items matching specific criteria.
/// </summary>
public static class DoesNotContainValidations
{
    ...
    public static bool CheckDoesNotContain<T>(this IEnumerable<T> collection, T item, IEqualityComparer<T>? comparer = null)
    {
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContain<T>(this IEnumerable<T> collection, T item, string variableName, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContain(item))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain {item}.", "DoesNotContain", blackboard, exceptionContext: new Dictionary<string, object?>
            {
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains the specified item.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContain<T>(this ICollection<T> collection, T item, string variableName, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContain(item))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain {item}.", "DoesNotContain", blackboard, exceptionContext: new Dictionary<string, object?>
    ...
    [DebuggerStepThrough]
    public static IEnumerable<T> ValidateDoesNotContain<T>(this IEnumerable<T> collection, Func<T, bool> predicate, string variableName, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContain(predicate))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain any item that matches the predicate.", "DoesNotContain", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "collection", collection },
                { "predicate", predicate }
            });
    ...
    /// <exception cref="ValidationException">Thrown when the collection contains any items that match the predicate.</exception>
    [DebuggerStepThrough]
    public static ICollection<T> ValidateDoesNotContain<T>(this ICollection<T> collection, Func<T, bool> predicate, string variableName, object? blackboard = null)
    {
        if (!collection.CheckDoesNotContain(predicate))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain any item that matches the predicate.", "DoesNotContain", blackboard, exceptionContext: new Dictionary<string, object?>
