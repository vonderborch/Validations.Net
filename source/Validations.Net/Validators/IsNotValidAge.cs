...
public static class IsNotValidAge
{
    ...
    public static ValidationResult ValidateIsNotValidAge(int value, int minAge, int maxAge, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidAdultAge(int value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidChildAge(int value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidSeniorAge(int value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidWorkingAge(int value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static void EnsureIsNotValidAge(int value, int minAge, int maxAge, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotValidAge(value, minAge, maxAge);
        var contextList = new List<(string, object?)>
        {
