...
public static class DoesNotContainAllValidations
{
    ...
    public static bool CheckDoesNotContainAll(this string? value, IEnumerable<string> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
    ...
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAll(this string? value, IEnumerable<string> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll(this string? value, StringComparison stringComparisonType = StringComparison.Ordinal, params string[] items)
    {
    ...
    /// <exception cref="ValidationException">Thrown when the string contains all of the specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAll(this string? value, StringComparison stringComparisonType, string variableName, object? blackboard = null, params string[] items)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll(this string? value, ICollection<string> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
    ...
    /// <exception cref="ValidationException">Thrown when the string contains all of the specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAll(this string? value, ICollection<string> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        if (!value.CheckDoesNotContainAll(items, stringComparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain any of the specified items.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value },
                { "items", items }
            });
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll(this string? value, IEnumerable<char> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
        return value.CheckDoesNotContainAll(items.ToList(), stringComparisonType);
    }
    ...
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAll(this string? value, IEnumerable<char> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        return value.ValidateDoesNotContainAll(items, variableName, stringComparisonType, blackboard);
    }
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll(this string? value, StringComparison stringComparisonType = StringComparison.Ordinal, params char[] items)
    {
        return value.CheckDoesNotContainAll(items, stringComparisonType);
    }
    ...
    /// <exception cref="ValidationException">Thrown when the string contains all of the specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAll(this string? value, StringComparison stringComparisonType, string variableName, object? blackboard = null, params char[] items)
    {
        return value.ValidateDoesNotContainAll(items, variableName, stringComparisonType, blackboard);
    }
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckDoesNotContainAll(this string? value, ICollection<char> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
        value.ValidateIsNotNull(nameof(value));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the string contains all of the specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateDoesNotContainAll(this string? value, ICollection<char> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        if (!value.CheckDoesNotContainAll(items, stringComparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must not contain any of the specified characters.", "DoesNotContainAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value },
                { "items", items }
            });
