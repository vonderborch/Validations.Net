...
public static class ContainsAnyValidations
{
    ...
    public static bool CheckContainsAny(this string? value, ICollection<string> items, StringComparison comparisonType = StringComparison.Ordinal)
    {
    ...
    [DebuggerStepThrough]
    public static string ValidateContainsAny(this string? value, ICollection<string> items, string variableName, StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny(this string? value, StringComparison comparisonType = StringComparison.Ordinal, params string[] items)
    {
    ...
    /// <exception cref="ValidationException">Thrown when the string does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAny(this string? value, string variableName, StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null, params string[] items)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny(this string? value, IEnumerable<string> items, StringComparison comparisonType = StringComparison.Ordinal)
    {
    ...
    /// <exception cref="ValidationException">Thrown when the string does not contain any of the specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAny(this string? value, IEnumerable<string> items, string variableName, StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny(this string? value, ICollection<char> items, StringComparison comparisonType = StringComparison.Ordinal)
    {
        value.ValidateIsNotNull(nameof(value));
        items.ValidateIsNotNull(nameof(items));
    ...
    [DebuggerStepThrough]
    public static string ValidateContainsAny(this string? value, ICollection<char> items, string variableName, StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        if (!value.CheckContainsAny(items, comparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must contain at least one of the specified characters.", "ContainsAny", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value },
                { "items", items }
            });
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny(this string? value, StringComparison comparisonType = StringComparison.Ordinal, params char[] items)
    {
        return value.CheckContainsAny(items, comparisonType);
    }
    ...
    /// <exception cref="ValidationException">Thrown when the string does not contain any of the specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAny(this string? value, string variableName, StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null, params char[] items)
    {
        return value.ValidateContainsAny(items, variableName, comparisonType, blackboard);
    }
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAny(this string? value, IEnumerable<char> items, StringComparison comparisonType = StringComparison.Ordinal)
    {
        return value.CheckContainsAny(items.ToList(), comparisonType);
    }
    ...
    /// <exception cref="ValidationException">Thrown when the string does not contain any of the specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAny(this string? value, IEnumerable<char> items, string variableName, StringComparison comparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        return value.ValidateContainsAny(items.ToList(), variableName, comparisonType, blackboard);
    }
}
