...
public static class ContainsValidations
{
    ...
    public static bool CheckContains(this string value, string substring, StringComparison comparisonType = StringComparison.Ordinal)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContains(this string value, char character, StringComparison comparisonType = StringComparison.Ordinal)
    {
        value.ValidateIsNotNull(nameof(value));
    ...
    [DebuggerStepThrough]
    public static string ValidateContains(this string value, string substring, StringComparison comparisonType = StringComparison.Ordinal, string variableName = "value", object? blackboard = null)
    {
        if (!value.CheckContains(substring, comparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must contain '{substring}'.", "Contains", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value },
                { "substring", substring }
            });
    ...
    [DebuggerStepThrough]
    public static string ValidateContains(this string value, char character, StringComparison comparisonType = StringComparison.Ordinal, string variableName = "value", object? blackboard = null)
    {
        if (!value.CheckContains(character, comparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must contain '{character}'.", "Contains", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value },
                { "character", character }
            });
