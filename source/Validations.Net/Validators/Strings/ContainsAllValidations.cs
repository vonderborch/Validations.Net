...
public static class ContainsAllValidations
{
    ...
    public static bool CheckContainsAll(this string? value, IEnumerable<string> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
    ...
    [DebuggerStepThrough]
    public static string ValidateContainsAll(this string? value, IEnumerable<string> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll(this string? value, StringComparison stringComparisonType = StringComparison.Ordinal, params string[] items)
    {
    ...
    /// <exception cref="ValidationException">Thrown when the string doesn't contain all specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAll(this string? value, StringComparison stringComparisonType, string variableName, object? blackboard = null, params string[] items)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll(this string? value, ICollection<string> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
    ...
    /// <exception cref="ValidationException">Thrown when the string doesn't contain all specified items.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAll(this string? value, ICollection<string> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll(this string? value, IEnumerable<char> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
        return value.CheckContainsAll(items.ToList(), stringComparisonType);
    }
    ...
    [DebuggerStepThrough]
    public static string ValidateContainsAll(this string? value, IEnumerable<char> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        return value.ValidateContainsAll(items, variableName, stringComparisonType, blackboard);
    }
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll(this string? value, StringComparison stringComparisonType = StringComparison.Ordinal, params char[] items)
    {
        return value.CheckContainsAll(items, stringComparisonType);
    }
    ...
    /// <exception cref="ValidationException">Thrown when the string doesn't contain all specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAll(this string? value, StringComparison stringComparisonType, string variableName, object? blackboard = null, params char[] items)
    {
        return value.ValidateContainsAll(items, variableName, stringComparisonType, blackboard);
    }
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckContainsAll(this string? value, ICollection<char> items, StringComparison stringComparisonType = StringComparison.Ordinal)
    {
        value.ValidateIsNotNull(nameof(value));
        items.ValidateIsNotNull(nameof(items));
    ...
    /// <exception cref="ValidationException">Thrown when the string doesn't contain all specified characters.</exception>
    [DebuggerStepThrough]
    public static string ValidateContainsAll(this string? value, ICollection<char> items, string variableName, StringComparison stringComparisonType = StringComparison.Ordinal, object? blackboard = null)
    {
        if (!value.CheckContainsAll(items, stringComparisonType))
        {
            throw new ValidationException(variableName, $"{variableName} must contain all specified characters.", "ContainsAll", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value },
                { "items", items }
            });
