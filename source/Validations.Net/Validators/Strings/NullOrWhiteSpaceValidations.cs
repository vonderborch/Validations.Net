...
public static class NullOrWhiteSpaceValidations
{
    ...
    public static string ValidateIsNullOrWhiteSpace(this string? value, string variableName, object? blackboard = null)
    {
        ...
        {
            throw new ValidationException(variableName, $"{variableName} must be null, empty, or white space.", "IsWhiteSpace", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value }
            });
        }
    ...
    public static string ValidateIsNotNullOrWhiteSpace(this string? value, string variableName, object? blackboard = null)
    {
        if (value.CheckIsNullOrWhiteSpace())
        {
            throw new ValidationException(variableName, $"{variableName} must not be null, empty, or white space.", "IsNotWhiteSpace", blackboard, exceptionContext: new Dictionary<string, object?>
            {
                { "value", value }
            });
        }
