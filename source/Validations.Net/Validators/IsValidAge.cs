...
public static class IsValidAge
{
    ...
    public static void EnsureIsValidAge(int value, int minAge, int maxAge, string fieldName,
    ...
    public static ValidationResult ValidateIsValidAge(int value, int minAge, int maxAge, string fieldName,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidAge(value, minAge, maxAge);
        var contextList = new List<(string, object?)>
    ...
    public static ValidationResult ValidateIsValidWorkingAge(int value, string fieldName,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidWorkingAge(value);
        var contextList = new List<(string, object?)>
