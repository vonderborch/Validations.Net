...
public static class IsNotPrime
{
    ...
    public static ValidationResult ValidateIsNotPrime(this int value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "Value must NOT be a prime number.", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is NOT a prime number.</returns>
    public static ValidationResult ValidateIsNotPrime(this long value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotPrime(value);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is NOT a prime number.</returns>
    public static ValidationResult ValidateIsNotPrime(this short value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotPrime(value);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is NOT a prime number.</returns>
    public static ValidationResult ValidateIsNotPrime(this byte value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotPrime(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsNotPrime(this int value, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "Value must NOT be a prime number.", fieldName, blackboard, contextList);
        }
    }
