...
public static class IsValidJson
{
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the string is valid JSON.</returns>
    public static ValidationResult ValidateIsValidJson(string? value, JsonDocumentOptions options, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsValidJsonObject(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsValidJsonArray(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsValidJsonPrimitive(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the string is not valid JSON.</exception>
    public static void EnsureIsValidJson(string? value, JsonDocumentOptions options, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidJson(value, options);
        var contextList = new List<(string, object?)>
        {
