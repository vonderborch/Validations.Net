...
public static class IsNotValidMacAddress
{
    ...
    {
        return !IsValidMacAddress.CheckIsValidMacAddress(value, allowedFormats);
    }
    ...
    {
        return !IsValidMacAddress.CheckIsValidDotSeparatedMacAddress(value);
    }
    ...
    public static ValidationResult ValidateIsNotValidMacAddress(this string? value, string fieldName, IBlackboard? blackboard, MacAddressFormat[]? allowedFormats = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidColonSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid colon-separated MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidHyphenSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid hyphen-separated MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidDotSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid dot-separated MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidNoSeparatorMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid MAC address without separators", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsNotValidMacAddress(this string? value, string fieldName, IBlackboard? blackboard, MacAddressFormat[]? allowedFormats = null)
    {
        var isValid = CheckIsNotValidMacAddress(value, allowedFormats);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidColonSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsNotValidColonSeparatedMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid colon-separated MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidHyphenSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsNotValidHyphenSeparatedMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid hyphen-separated MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidDotSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsNotValidDotSeparatedMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid dot-separated MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidNoSeparatorMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsNotValidNoSeparatorMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid MAC address without separators", null, null, contextList);
        }
    }
}
