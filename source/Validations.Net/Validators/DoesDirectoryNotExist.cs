...
public static class DoesDirectoryNotExist
{
    ...
    {
        return !directoryPath.CheckDoesDirectoryExist();
    }
    ...
    public static void EnsureDoesDirectoryNotExist(this string? directoryPath, string fieldName,
    ...
    public static ValidationResult ValidateDoesDirectoryNotExist(this string? directoryPath, string fieldName,
        IBlackboard? blackboard)
    {
        var isValid = CheckDoesDirectoryNotExist(directoryPath);
        var contextList = new List<(string, object?)>
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The directory must not exist", fieldName,
