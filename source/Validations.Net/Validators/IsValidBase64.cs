...
public static class IsValidBase64
{
    ...
    public static bool CheckIsValidBase64WithPadding(string? value)
    {
        ...
        var paddingCount = 0;
        for (var i = length - 1; i >= 0 && value[i] == '='; i--)
        {
            paddingCount++;
        }
    ...
    public static void EnsureIsValidBase64WithLength(string? value, int expectedLength, string fieldName,
    ...
    ///     Thrown when the string is not valid Base64 with at least the minimum decoded
    ///     length.
    /// </exception>
    public static void EnsureIsValidBase64WithMinimumLength(string? value, int minimumLength, string fieldName,
        IBlackboard? blackboard = null)
    {
    ...
    public static void EnsureIsValidBase64WithoutPadding(string? value, string fieldName,
        IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsValidBase64(string? value, string fieldName,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidBase64(value);
        var contextList = new List<(string, object?)>
    ...
    public static ValidationResult ValidateIsValidBase64WithLength(string? value, int expectedLength, string fieldName,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidBase64WithLength(value, expectedLength);
        var contextList = new List<(string, object?)>
    ...
    public static ValidationResult ValidateIsValidBase64WithMinimumLength(string? value, int minimumLength,
    ...
    public static ValidationResult ValidateIsValidBase64WithoutPadding(string? value, string fieldName,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidBase64WithoutPadding(value);
        var contextList = new List<(string, object?)>
    ...
    public static ValidationResult ValidateIsValidBase64WithPadding(string? value, string fieldName,
        IBlackboard? blackboard = null)
    {
        var isValid = CheckIsValidBase64WithPadding(value);
        var contextList = new List<(string, object?)>
