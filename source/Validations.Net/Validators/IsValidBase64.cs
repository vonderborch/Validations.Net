...
public static class IsValidBase64
{
    ...
    public static ValidationResult ValidateIsValidBase64(string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    public static ValidationResult ValidateIsValidBase64WithPadding(string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    public static ValidationResult ValidateIsValidBase64WithoutPadding(string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    public static ValidationResult ValidateIsValidBase64WithLength(string? value, int expectedLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    public static ValidationResult ValidateIsValidBase64WithMinimumLength(string? value, int minimumLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    public static void EnsureIsValidBase64(string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var isValid = CheckIsValidBase64(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsValidBase64WithPadding(string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var isValid = CheckIsValidBase64WithPadding(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsValidBase64WithoutPadding(string? value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var isValid = CheckIsValidBase64WithoutPadding(value);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsValidBase64WithLength(string? value, int expectedLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var isValid = CheckIsValidBase64WithLength(value, expectedLength);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsValidBase64WithMinimumLength(string? value, int minimumLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var isValid = CheckIsValidBase64WithMinimumLength(value, minimumLength);
        var contextList = new List<(string, object?)>
        {
