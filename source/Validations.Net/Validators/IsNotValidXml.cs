...
public static class IsNotValidXml
{
    ...
    public static ValidationResult ValidateIsNotValidXml(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A validation result indicating whether the string is NOT valid XML.</returns>
    public static ValidationResult ValidateIsNotValidXml(string? value, LoadOptions options, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidXmlDocument(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidXmlFragment(string? value, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    public static ValidationResult ValidateIsNotValidXmlWithRootElement(string? value, string rootElementName, string fieldName, IBlackboard? blackboard = null)
    {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the string is valid XML.</exception>
    public static void EnsureIsNotValidXml(string? value, LoadOptions options, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotValidXml(value, options);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsNotValidXmlWithRootElement(string? value, string rootElementName, string fieldName, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsNotValidXmlWithRootElement(value, rootElementName);
        var contextList = new List<(string, object?)>
        {
