...
public static class IsNotWhiteSpace
{
    ...
    public static string? EnsureIsNotWhiteSpace(this string? value, string? parameterName = null, IBlackboard? blackboard = null)
    {
        ValidationResult result = value.ValidateIsNotWhiteSpace(parameterName, blackboard);
        if (!result.IsValid) {
    ...
    public static ValidationResult ValidateIsNotWhiteSpace(this string? value, string? parameterName = null, IBlackboard? blackboard = null)
    {
