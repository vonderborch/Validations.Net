...
public static class DoesNotContain
{
    ...
    /// <summary>
    ///     Validates that a string does not contain a specified substring, throwing a <see cref="ValidationException" /> if it
    ///     does.
    /// </summary>
        ...
        StringComparison comparison = StringComparison.Ordinal, Blackboard? blackboard = null)
    {
        ...
        {
            throw new ValidationException("DoesNotContain", propertyName,
                $"{propertyName} must not contain {subString}.", blackboard, new Dictionary<string, object?>
                {
                    { "value", value },
                    { "subString", subString }
                });
    ...
    /// <summary>
    ///     Validates that a substring of a string does not contain a specified substring, throwing a
    ...
    /// <summary>
    ///     Validates that a string does not contain a specified character, throwing a <see cref="ValidationException" /> if it
    ///     does.
    /// </summary>
    /// <param name="value">The string to validate.</param>
    /// <param name="character">The character to search for.</param>
        ...
        Blackboard? blackboard = null)
    {
        ...
        {
            throw new ValidationException("DoesNotContain", propertyName,
                $"{propertyName} must not contain '{character}'.",
    ...
    /// <summary>
    ///     Validates that a substring of a string does not contain a specified character, throwing a
    ///     <see cref="ValidationException" /> if it does.
    /// </summary>
    /// <param name="value">The string to validate.</param>
    /// <param name="character">The character to search for.</param>
    ...
    public static string ValidateDoesNotContain(this string? value, char character, string propertyName, int startIndex,
        int? count = null,
        StringComparison comparison = StringComparison.Ordinal,
        Blackboard? blackboard = null)
    {
    ...
    /// <summary>
    ///     Validates that a collection does not contain a specified item, throwing a <see cref="ValidationException" /> if it
    ///     does.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    ...
    /// <summary>
    ///     Validates that a collection does not contain any elements matching a predicate, throwing a
    ///     <see cref="ValidationException" /> if it does.
    /// </summary>
    /// <typeparam name="T">The type of elements in the collection.</typeparam>
    /// <param name="collection">The collection to validate.</param>
