...
public static class IsGreaterThanOrEquals
{
    ...
    /// <returns>True if the value is greater than or equal to the comparison value; otherwise, false. Null values are considered less than any non-null value.</returns>
    ...
    /// <summary>
    /// Validates that a value is greater than or equal to another value, throwing a <see cref="ValidationException"/> if it isn't.
    /// </summary>
    /// <typeparam name="T">The type of the values to compare. Must implement <see cref="IComparable{T}"/>.</typeparam>
