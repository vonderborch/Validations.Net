...
public static class IsNotNullOrEmpty
{
    ...
    public static bool CheckIsNotNullOrEmpty<T>(this T?[]? value)
    {
    ...
    public static T[] ValidateIsNotNullOrEmpty<T>(this T[]? value, string propertyName, Blackboard? blackboard = null)
    {
