...
public static class IsNotOneOf
{
    ...
    /// If the value is one of the specified options, returns a <see cref="ValidationResult"/> containing validation failure details.
    /// </summary>
    ...
    public static ValidationResult ValidateIsNotOneOf<T>(this T? value, string variableName, Blackboard? blackboard = null,
        params T[] options)
    {
