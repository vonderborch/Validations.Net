...
public static class IsLength
{
    ...
    public static ICollection<T> ValidateIsLength<T>(this ICollection<T>? value, int length, string propertyName,
        Blackboard? blackboard = null)
    {
        if (!value.CheckIsLength(length))
        {
            throw new ValidationException("IsLength", propertyName, $"{propertyName} must have a length of {length}.",
    ...
    public static string ValidateIsLength(this string? value, int length, string propertyName,
        Blackboard? blackboard = null)
    {
        if (!value.CheckIsLength(length))
        {
