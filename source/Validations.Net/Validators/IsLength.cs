...
public static class IsLength
{
    ...
    /// <param name="length">The expected length of the collection.</param>
    /// <returns>True if the collection has the specified length; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength<T>(this T? value, int length) where T : ICollection
    {
    ...
    public static T EnsureIsLength<T>(this T? value, int length, string propertyName,
    ...
    public static string EnsureIsLength(this string? value, int length, string propertyName,
    ...
    ///     If the collection does not have the specified length, returns a <see cref="ValidationResult" /> containing
    ...
    public static ValidationResult ValidateIsLength<T>(this T? value, int length, string variableName,
        IBlackboard? blackboard = null) where T : ICollection
    {
    ...
    ///     If the string does not have the specified length, returns a <see cref="ValidationResult" /> containing validation
    ///     failure details.
    /// </summary>
    /// <param name="value">The string to validate.</param>
    /// <param name="length">The expected length.</param>
    ...
    /// <param name="blackboard">An optional blackboard object for storing contextual validation details.</param>
    /// <returns>A <see cref="ValidationResult" /> indicating the success or failure of the validation.</returns>
    public static ValidationResult ValidateIsLength(this string? value, int length, string variableName,
        IBlackboard? blackboard = null)
    {
        if (!value.CheckIsLength(length))
        {
