...
public static class IsLength
{
    ...
    public static bool CheckIsLength(this string? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength(this IEnumerable? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength)
    {
        if (value is null) return false;
        ...
        foreach (var _ in value)
        {
            ...
            if (mode == LengthCheckMode.LessThan && count >= expectedLength) return false;
            if (mode == LengthCheckMode.LessThanOrEqual && count > expectedLength) return false;
        }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength<T>(this ReadOnlySpan<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength)
    {
        return CheckLength(value.Length, expectedLength, mode);
    }
    ...
    /// <returns>True if the span length matches the criteria, false otherwise.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength<T>(this Span<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength)
    {
        return CheckLength(value.Length, expectedLength, mode);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength<T>(this Memory<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength)
    {
        return CheckLength(value.Length, expectedLength, mode);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength(this StringBuilder? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength)
    {
        if (value is null) return false;
        return CheckLength(value.Length, expectedLength, mode);
    }
    ...
    /// <returns>True if the collection length matches the criteria, false otherwise.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsLength<T>(this T? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength) where T : ICollection
    {
        if (value is null) return false;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsLength(this string? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsLength(expectedLength, mode, null, parameterName);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsLength(this IEnumerable? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsLength(expectedLength, mode, null, parameterName);
        if (!validationResult.IsValid)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsLength<T>(this ReadOnlySpan<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsLength(expectedLength, mode, null, parameterName);
        if (!validationResult.IsValid)
        {
    ...
    /// <exception cref="ValidationException">Thrown when the span length does not match the criteria.</exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsLength<T>(this Span<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsLength(expectedLength, mode, null, parameterName);
        if (!validationResult.IsValid)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsLength<T>(this Memory<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsLength(expectedLength, mode, null, parameterName);
        if (!validationResult.IsValid)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsLength(this StringBuilder? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsLength(expectedLength, mode, null, parameterName);
        if (!validationResult.IsValid)
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength(this string? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength(this IEnumerable? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (CheckIsLength(value, expectedLength, mode))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength<T>(this ReadOnlySpan<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (CheckIsLength(value, expectedLength, mode))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    /// <returns>A ValidationResult indicating whether the span length matches the criteria.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength<T>(this Span<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (CheckIsLength(value, expectedLength, mode))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength<T>(this Memory<T> value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (CheckIsLength(value, expectedLength, mode))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength(this StringBuilder? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        if (CheckIsLength(value, expectedLength, mode))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    /// <returns>A ValidationResult indicating whether the collection length matches the criteria.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsLength<T>(this T? value, int expectedLength, LengthCheckMode mode = LengthCheckMode.ExactLength, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null) where T : ICollection
    {
        if (CheckIsLength(value, expectedLength, mode))
        {
            return ValidationResult.CreateFromValidationSuccess();
