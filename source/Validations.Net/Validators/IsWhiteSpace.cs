...
public static class IsWhiteSpace
{
    ...
    public static ValidationResult ValidateIsWhiteSpace(this string? value, string variableName, Blackboard? blackboard = null)
    {
    ...
    public static string EnsureIsWhiteSpace(this string? value, string propertyName, Blackboard? blackboard = null)
    {
