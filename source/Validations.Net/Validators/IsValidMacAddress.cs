...
public static class IsValidMacAddress
{
    ...
    public static ValidationResult ValidateIsValidMacAddress(this string? value, string fieldName, IBlackboard? blackboard, MacAddressFormat[]? allowedFormats = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidColonSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid colon-separated MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidHyphenSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid hyphen-separated MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidDotSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid dot-separated MAC address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsValidNoSeparatorMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid MAC address without separators", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsValidMacAddress(this string? value, string fieldName, IBlackboard? blackboard, MacAddressFormat[]? allowedFormats = null)
    {
        var isValid = CheckIsValidMacAddress(value, allowedFormats);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsValidColonSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsValidColonSeparatedMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid colon-separated MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsValidHyphenSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsValidHyphenSeparatedMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid hyphen-separated MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsValidDotSeparatedMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        var isValid = CheckIsValidDotSeparatedMacAddress(value);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid dot-separated MAC address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsValidNoSeparatorMacAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid MAC address without separators", null, null, contextList);
        }
    }
}
