...
public static class IsNotValidIpAddress
{
    ...
    public static ValidationResult ValidateIsNotValidIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid IP address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidIPv4Address(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid IPv4 address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidIPv6Address(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid IPv6 address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidPrivateIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid private IP address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidPublicIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid public IP address", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsNotValidLoopbackIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must not be a valid loopback IP address", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsNotValidIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid IP address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidIPv4Address(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid IPv4 address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidIPv6Address(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid IPv6 address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidPrivateIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid private IP address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidPublicIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid public IP address", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsNotValidLoopbackIpAddress(this string? value, string fieldName, IBlackboard? blackboard)
    {
        ...
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must not be a valid loopback IP address", null, null, contextList);
        }
    }
}
