...
public static class IsDivisibleBy
{
    ...
    public static ValidationResult ValidateIsDivisibleBy(this int value, int divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, $"Value must be divisible by {divisor}.", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is divisible by the divisor.</returns>
    public static ValidationResult ValidateIsDivisibleBy(this long value, long divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is divisible by the divisor.</returns>
    public static ValidationResult ValidateIsDivisibleBy(this short value, short divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <returns>A ValidationResult indicating whether the value is divisible by the divisor.</returns>
    public static ValidationResult ValidateIsDivisibleBy(this byte value, byte divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        var contextList = new List<(string, object?)>
        {
    ...
    public static void EnsureIsDivisibleBy(this int value, int divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, $"Value must be divisible by {divisor}.", fieldName, blackboard, contextList);
        }
    }
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is not divisible by the divisor.</exception>
    public static void EnsureIsDivisibleBy(this long value, long divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        if (!isValid)
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is not divisible by the divisor.</exception>
    public static void EnsureIsDivisibleBy(this short value, short divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        if (!isValid)
        {
    ...
    /// <param name="blackboard">Optional blackboard for additional context.</param>
    /// <exception cref="ValidationException">Thrown when the value is not divisible by the divisor.</exception>
    public static void EnsureIsDivisibleBy(this byte value, byte divisor, string? fieldName = null, IBlackboard? blackboard = null)
    {
        var isValid = CheckIsDivisibleBy(value, divisor);
        if (!isValid)
        {
