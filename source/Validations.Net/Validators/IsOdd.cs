...
public static class IsOdd
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsOdd(this int value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? fieldName = null)
    {
        if (CheckIsOdd(value))
        {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValidationResult ValidateIsOdd(this long value, IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? fieldName = null)
    {
        if (CheckIsOdd(value))
        {
            return ValidationResult.CreateFromValidationSuccess();
    ...
    public static int EnsureIsOdd(this int value)
    {
        if (!CheckIsOdd(value))
        {
            ...
            throw ValidationException.Create(ValidatorName, $"The value must be odd. Actual value: {value}", null, null, contextList);
        }
