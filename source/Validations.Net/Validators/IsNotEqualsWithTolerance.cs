...
/// <summary>
///     Provides extension methods for validating that numeric values are not approximately equal to a specified value
///     within a tolerance.
/// </summary>
public static class IsNotEqualsWithTolerance
{
    ...
    /// <returns>
    ///     True if the absolute difference between the values is greater than the tolerance; otherwise, false. Two null
    ...
    /// <summary>
    ///     Validates that a numeric value is not approximately equal to another value within a specified tolerance, throwing a
    ...
    ///     Thrown when the absolute difference between the values is less than or equal to
    ///     the tolerance.
    /// </exception>
    public static T ValidateIsNotEqualsWithTolerance<T>(this T value, T compareTo, T tolerance, string propertyName,
        Blackboard? blackboard = null) where T : INumber<T>
    {
        if (!value.CheckIsNotEqualsWithTolerance(compareTo, tolerance))
        {
            throw new ValidationException("IsNotEqualsWithTolerance", propertyName,
                $"{propertyName} must not be approximately equal to {compareTo} within a tolerance of {tolerance}.",
                blackboard,
