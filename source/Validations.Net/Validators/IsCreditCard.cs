...
public static class IsCreditCard
{
    ...
    public static ValidationResult ValidateIsCreditCard(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        ...
        return isValid
            ...
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid credit card number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="validateLuhn">Whether to validate using the Luhn algorithm. Default is true.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsVisaCard(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid Visa card number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="validateLuhn">Whether to validate using the Luhn algorithm. Default is true.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsMasterCard(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid MasterCard number", fieldName, blackboard, contextList);
    }
    ...
    /// <param name="validateLuhn">Whether to validate using the Luhn algorithm. Default is true.</param>
    /// <returns>A ValidationResult indicating success or failure.</returns>
    public static ValidationResult ValidateIsAmericanExpress(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        ...
        return isValid
            ? ValidationResult.CreateFromValidationSuccess()
            : ValidationResult.CreateFromValidationFailure(ValidatorName, "The value must be a valid American Express card number", fieldName, blackboard, contextList);
    }
    ...
    public static void EnsureIsCreditCard(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        var isValid = CheckIsCreditCard(value, validateLuhn);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid credit card number", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsVisaCard(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        var isValid = CheckIsVisaCard(value, validateLuhn);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid Visa card number", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsMasterCard(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        var isValid = CheckIsMasterCard(value, validateLuhn);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid MasterCard number", null, null, contextList);
        }
    }
    ...
    public static void EnsureIsAmericanExpress(this string? value, string fieldName, IBlackboard? blackboard, bool validateLuhn = true)
    {
        var isValid = CheckIsAmericanExpress(value, validateLuhn);
        if (!isValid)
        {
            ...
            throw ValidationException.Create(ValidatorName, "The value must be a valid American Express card number", null, null, contextList);
        }
    }
}
