...
/// </param>
/// <param name="group">
///     The group associated with the predicate. The group is used to organize predicates into distinct
///     logical collections, providing a means to differentiate and manage predicates based on their context or purpose.
///     Defaults to `default`.
/// </param>
