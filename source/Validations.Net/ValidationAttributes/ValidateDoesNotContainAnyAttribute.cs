...
public class ValidateDoesNotContainAnyAttribute<T> : ValidationAttribute
{
    ...
    /// <returns>
    ///     True if the value does not contain any of the specified items or satisfy any of the specified predicates,
    ///     false otherwise.
    /// </returns>
    ...
    public override bool Check(object? value)
    {
        ...
        {
            return collection.CheckDoesNotContainAny(this.Items!);
        }

        return collection.CheckDoesNotContainAny(this.Predicates);
    }

    /// <summary>
    ///     Validates if the provided value does not contain any of the specified items or satisfy any of the specified
    ...
    ///     Thrown when the value contains any of the specified items or satisfies any of the
    ...
    public override void Validate(object? value, string propertyName, Blackboard? blackboard = null)
    {
        ...
        if (this.Predicates is null)
        {
            collection.ValidateDoesNotContainAny(this.Items!, propertyName, blackboard);
        }
        else
        {
            collection.ValidateDoesNotContainAny(this.Predicates, propertyName, blackboard);
        }
    }
}
