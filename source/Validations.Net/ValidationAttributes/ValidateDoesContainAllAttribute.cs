...
/// <summary>
/// Attribute that validates if a collection contains all of the specified items or satisfies all of the specified predicates.
/// </summary>
...
public class ValidateDoesContainAllAttribute<T> : ValidationAttribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the ValidateDoesContainAllAttribute class with a collection of predicate functions from a specified group.
    /// </summary>
    ...
    /// <returns>True if the value contains all of the specified items or satisfies all of the specified predicates, false otherwise.</returns>
    ...
    /// <summary>
    /// Validates if the provided value contains all of the specified items or satisfies all of the specified predicates and throws a ValidationException if it does not.
    /// </summary>
    /// <param name="value">The value to validate. Must be a collection of type T.</param>
    /// <param name="propertyName">The name of the property being validated.</param>
    /// <param name="blackboard">Optional blackboard for storing validation context.</param>
    /// <exception cref="ValidationException">Thrown when the value does not contain all of the specified items or satisfy all of the specified predicates, or when the value is not a collection of type T.</exception>
