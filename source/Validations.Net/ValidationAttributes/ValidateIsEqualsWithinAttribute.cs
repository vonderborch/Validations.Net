...
public class ValidateIsEqualsWithinAttribute<T>(T compareTo, T tolerance) : ValidationAttribute("IsEqualsWithin") where T : INumber<T>
{
    /// <summary>
    ...
    public override bool Check(object? value)
    {
        ...
        return typedValue.CheckIsEqualsWithin(CompareTo, Tolerance);
    }

    /// <summary>
    /// Validates if the provided value equals the comparison value within the specified tolerance and throws a ValidationException if it does not.
    /// </summary>
    ...
    {
        T typedValue = GetCorrectType<T>(value, nameof(value));
        typedValue.ValidateIsEqualsWithin(CompareTo, Tolerance, propertyName, blackboard);
    }
}
