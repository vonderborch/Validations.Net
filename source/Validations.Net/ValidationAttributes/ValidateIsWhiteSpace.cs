...
public class ValidateIsWhiteSpace() : ValidationAttribute("IsWhiteSpace")
{
    ...
    /// <summary>
    /// Validates if the provided value consists only of white-space characters and throws a ValidationException if it does not.
    /// </summary>
    /// <param name="value">The value to validate. Must be a string.</param>
    /// <param name="propertyName">The name of the property being validated.</param>
    /// <param name="blackboard">Optional blackboard for storing validation context.</param>
    /// <exception cref="ValidationException">Thrown when the value does not consist only of white-space characters or is not a string.</exception>
