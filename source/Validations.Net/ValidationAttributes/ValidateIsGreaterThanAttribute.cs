    ...
    : ValidationAttribute("IsGreaterThan") where T : IComparable<T>
{
    ...
    public override bool Check(object? value, object? instance)
    {
        ...
        return typedValue.CheckIsGreaterThan(this.CompareTo);
    }

    /// <summary>
    ///     Validates if the provided value is greater than the comparison value and throws a ValidationException if it is not.
    /// </summary>
    ...
    {
        T typedValue = GetCorrectType<T>(value, nameof(value));
        typedValue.ValidateIsGreaterThan(this.CompareTo, propertyName, blackboard);
    }
}
