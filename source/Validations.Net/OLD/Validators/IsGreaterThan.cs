...
public static class IsGreaterThan
{
    ...
    /// <summary>
    /// Checks if the given value is greater than the comparand (non-generic overload for boxed values).
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool CheckIsGreaterThan(this IComparable? value, object? comparand)
    {
...
public sealed class IsGreaterThanValidator : IValidator
{
    ...
    {
        if (value is IComparable comparable && comparable.CheckIsGreaterThan(this.Comparand))
            return ValidationResult.CreateFromValidationSuccess();
