...
public sealed class NullOrEmptyValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        return value switch
        {
            ...
            string s => s.ValidateIsNullOrEmpty(blackboard, this.DefaultFailureMessage, memberName),
            System.Collections.IEnumerable e when value is not string => e.Cast<object?>().ValidateIsNullOrEmpty(blackboard, this.DefaultFailureMessage, memberName),
