...
public sealed class FiniteValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        return value switch
        {
            ...
            double v => v.ValidateIsFinite(blackboard, this.DefaultFailureMessage, memberName),
            float v => v.ValidateIsFinite(blackboard, this.DefaultFailureMessage, memberName),
            Half v => v.ValidateIsFinite(blackboard, this.DefaultFailureMessage, memberName),
            decimal v => v.ValidateIsFinite(blackboard, this.DefaultFailureMessage, memberName),
