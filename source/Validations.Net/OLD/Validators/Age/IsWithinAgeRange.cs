...
namespace Validations.Net.OLD.Validators.Age;
...
public sealed class WithinAgeRangeValidator : IValidator
{
    ...
    {
        this.Params = new WithinAgeRangeParams(minAge, maxAge);
    }
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        return value switch
        {
            int age when age.CheckIsWithinAgeRange(this.Params.MinAge, this.Params.MaxAge) => ValidationResult.CreateFromValidationSuccess(),
            int age => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", (object)age), ("minAge", (object)this.Params.MinAge), ("maxAge", (object)this.Params.MaxAge)]),
            System.DateTime dob when dob.CheckIsWithinAgeRange(this.Params.MinAge, this.Params.MaxAge) => ValidationResult.CreateFromValidationSuccess(),
            System.DateTime dob => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", (object)dob), ("minAge", (object)this.Params.MinAge), ("maxAge", (object)this.Params.MaxAge)]),
            DateTimeOffset dob when dob.CheckIsWithinAgeRange(this.Params.MinAge, this.Params.MaxAge) => ValidationResult.CreateFromValidationSuccess(),
            DateTimeOffset dob => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", (object)dob), ("minAge", (object)this.Params.MinAge), ("maxAge", (object)this.Params.MaxAge)]),
            _ => ValidationResult.CreateFromValidationFailure(this.Name, "Value is not an int, DateTime, or DateTimeOffset", memberName, blackboard,
                [("value", value)])
        };
    }
}
...
public sealed class ValidateIsWithinAgeRangeAttribute(int minAge, int maxAge) : ValidationAttribute(IsWithinAgeRange.ValidatorName)
{
    ...
    {
        if (value is int age)
            return age.CheckIsWithinAgeRange(this._minAge, this._maxAge) ? ValidationResult.CreateFromValidationSuccess() : Fail(age, memberName, blackboard);
        if (value is System.DateTime dt)
            return dt.CheckIsWithinAgeRange(this._minAge, this._maxAge) ? ValidationResult.CreateFromValidationSuccess() : Fail(dt, memberName, blackboard);
        if (value is DateTimeOffset dto)
            return dto.CheckIsWithinAgeRange(this._minAge, this._maxAge) ? ValidationResult.CreateFromValidationSuccess() : Fail(dto, memberName, blackboard);
    ...
    {
        var message = this.Message ?? IsWithinAgeRange.DefaultValidationFailureMessage;
        return ValidationResult.CreateFromValidationFailure(this.Name, message, memberName, blackboard,
            [("value", value), ("minAge", (object)this._minAge), ("maxAge", (object)this._maxAge)]);
    }
}
