...
public sealed class AdultValidator : IValidator
{
    ...
    {
        this.Params = new AdultParams(adultAge);
    }
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        return value switch
        {
            int age when age.CheckIsAdult(this.Params.AdultAge) => ValidationResult.CreateFromValidationSuccess(),
            int age => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", (object)age), ("adultAge", (object)this.Params.AdultAge)]),
            System.DateTime dob when dob.CheckIsAdult(this.Params.AdultAge) => ValidationResult.CreateFromValidationSuccess(),
            System.DateTime dob => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", (object)dob), ("adultAge", (object)this.Params.AdultAge)]),
            DateTimeOffset dob when dob.CheckIsAdult(this.Params.AdultAge) => ValidationResult.CreateFromValidationSuccess(),
...
public sealed class ValidateIsAdultAttribute(int adultAge = 18) : ValidationAttribute(IsAdult.ValidatorName)
{
    ...
    {
        if (value is int age)
            return age.CheckIsAdult(this._adultAge) ? ValidationResult.CreateFromValidationSuccess() : Fail(age, memberName, blackboard);
        if (value is System.DateTime dt)
            return dt.CheckIsAdult(this._adultAge) ? ValidationResult.CreateFromValidationSuccess() : Fail(dt, memberName, blackboard);
        if (value is DateTimeOffset dto)
            return dto.CheckIsAdult(this._adultAge) ? ValidationResult.CreateFromValidationSuccess() : Fail(dto, memberName, blackboard);
    ...
    {
        var message = this.Message ?? IsAdult.DefaultValidationFailureMessage;
        return ValidationResult.CreateFromValidationFailure(this.Name, message, memberName, blackboard,
            [("value", value), ("adultAge", (object)this._adultAge)]);
    }
}
