...
namespace Validations.Net.OLD.Validators.Finance;
...
public sealed class ValidBicSwiftValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        if (value is string s)
            return s.ValidateIsValidBicSwift(blackboard, this.DefaultFailureMessage, memberName);
...
public sealed class ValidateIsValidBicSwiftAttribute() : ValidationAttribute(IsValidBicSwift.ValidatorName)
{
    ...
    {
        var message = this.Message ?? IsValidBicSwift.DefaultValidationFailureMessage;
