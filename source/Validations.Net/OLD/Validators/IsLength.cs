...
public sealed class IsLengthValidator : IValidator
{
    ...
    {
        this.Params = new IsLengthParams(length);
    }
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        return value switch
        {
            string s when s.CheckIsLength(this.Params.Length) => ValidationResult.CreateFromValidationSuccess(),
            string s => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", value), ("expectedLength", this.Params.Length), ("actualLength", s.Length)]),
            System.Collections.ICollection c when c.CheckIsLength(this.Params.Length) => ValidationResult.CreateFromValidationSuccess(),
            System.Collections.ICollection c => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", value), ("expectedLength", this.Params.Length), ("actualLength", c.Count)]),
            _ => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", value), ("expectedLength", this.Params.Length)])
        };
    }
}
