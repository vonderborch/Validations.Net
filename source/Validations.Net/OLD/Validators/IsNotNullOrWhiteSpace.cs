...
public sealed class NotNullOrWhiteSpaceValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
        => value is string s ? s.ValidateIsNotNullOrWhiteSpace(blackboard, this.DefaultFailureMessage, memberName)
            : ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard, [("value", value)]);
}

public sealed class ValidateIsNotNullOrWhiteSpaceAttribute() : ValidatorAttribute(NotNullOrWhiteSpaceValidator.Instance);
