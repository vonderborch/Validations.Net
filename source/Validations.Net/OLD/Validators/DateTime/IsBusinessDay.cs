...
public sealed class IsBusinessDayValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        if (value is System.DateTime dt)
            return dt.ValidateIsBusinessDay(blackboard, this.DefaultFailureMessage, memberName);
        if (value is DateTimeOffset dto)
            return dto.ValidateIsBusinessDay(blackboard, this.DefaultFailureMessage, memberName);
...
public sealed class ValidateIsBusinessDayAttribute() : ValidationAttribute(IsBusinessDay.ValidatorName)
{
    ...
    {
        var message = this.Message ?? IsBusinessDay.DefaultValidationFailureMessage;
