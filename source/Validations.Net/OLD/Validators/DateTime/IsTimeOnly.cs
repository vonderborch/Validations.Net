...
public sealed class IsTimeOnlyValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        if (value is System.DateTime dt)
            return dt.ValidateIsTimeOnly(blackboard, this.DefaultFailureMessage, memberName);
        if (value is DateTimeOffset dto)
            return dto.ValidateIsTimeOnly(blackboard, this.DefaultFailureMessage, memberName);
...
public sealed class ValidateIsTimeOnlyAttribute() : ValidationAttribute(IsTimeOnly.ValidatorName)
{
    ...
    {
        var message = this.Message ?? IsTimeOnly.DefaultValidationFailureMessage;
