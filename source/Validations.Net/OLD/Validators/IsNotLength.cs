...
public sealed class NotLengthValidator : IValidator
{
    ...
    {
        this.Params = new NotLengthParams(length);
    }
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        ...
        return value switch
        {
            string s when s.CheckIsNotLength(this.Params.Length) => ValidationResult.CreateFromValidationSuccess(),
            string s => ValidationResult.CreateFromValidationFailure(this.Name, this.DefaultFailureMessage, memberName, blackboard,
                [("value", value), ("length", this.Params.Length), ("actualLength", s.Length)]),
            System.Collections.ICollection c when c.CheckIsNotLength(this.Params.Length) => ValidationResult.CreateFromValidationSuccess(),
