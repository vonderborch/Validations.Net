...
public sealed class OddValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        return value switch
        {
            ...
            int v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            long v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            short v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            byte v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            uint v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            ulong v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            ushort v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            sbyte v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            nint v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            nuint v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            Int128 v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            UInt128 v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            BigInteger v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            double v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            float v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            Half v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
            decimal v => v.ValidateIsOdd(blackboard, this.DefaultFailureMessage, memberName),
