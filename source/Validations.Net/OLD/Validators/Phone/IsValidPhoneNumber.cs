...
namespace Validations.Net.OLD.Validators.Phone;
...
public sealed class ValidPhoneNumberValidator : IValidator
{
    ...
    public ValidationResult Validate(object? value, string? memberName = null, IBlackboard? blackboard = null)
    {
        if (value is string s)
            return s.ValidateIsValidPhoneNumber(blackboard, this.DefaultFailureMessage, memberName);
...
public sealed class ValidateIsValidPhoneNumberAttribute() : ValidationAttribute(IsValidPhoneNumber.ValidatorName)
{
    ...
    {
        var message = this.Message ?? IsValidPhoneNumber.DefaultValidationFailureMessage;
