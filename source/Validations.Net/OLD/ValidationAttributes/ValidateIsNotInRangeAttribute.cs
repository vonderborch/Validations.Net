...
public class ValidateIsNotInRangeAttribute<T> : ValidationAttribute where T : INumber<T>
{
    ...
    public override bool Check(object? value, object? instance)
    {
        ...
        return typedValue.ConvertedValue!.CheckIsNotInRange(this.Min, this.Max, this.MinIsInclusive, this.MaxIsInclusive);
    }
    ...
    public override ValidationResult Validate(object? value, object? instance, string propertyName, IBlackboard? blackboard = null)
    {
        ...
        return typedValue.ConvertedValue!.ValidateIsNotInRange(this.Min, this.Max, propertyName, this.MinIsInclusive, this.MaxIsInclusive, blackboard);
    }
}
