...
public static class AgainstPredicate
{
    ...
    public static T? EnsureAgainstPredicate<T>(this T? value, string predicateName, string? predicateGroup = null,
        object? predicateInstance = null, string? parameterName = null, IBlackboard? blackboard = null)
    {
    ...
    {
        var validationResult = value.ValidateAgainstPredicate(predicate, parameterName, blackboard);
        if (!validationResult.IsValid)
        {
            throw validationResult.ValidationException!;
        }
    ...
    public static ValidationResult ValidateAgainstPredicate<T>(this T? value, string predicateName,
        string? predicateGroup = null, object? predicateInstance = null, string? parameterName = null,
