...
{
    private const string ValidatorName = nameof(DoesNotContainAll);
        ...
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(
            ValidatorName,
            "The value must not contain all of the specified substrings.",
            parameterName,
            blackboard,
            contextList);
    }
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(
            ValidatorName,
            $"The value must not contain all of the specified substrings using {comparisonType} comparison.",
            parameterName,
            blackboard,
            contextList);
    }
        ...
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(
            ValidatorName,
            "The value must not contain all of the specified characters.",
            parameterName,
            blackboard,
            contextList);
    }
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(
            ValidatorName,
            $"The value must not contain all of the specified characters using {comparisonType} comparison.",
            parameterName,
            blackboard,
            contextList);
    }
        ...
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(
            ValidatorName,
            "The value must not contain all of the specified items.",
            parameterName,
            blackboard,
            contextList);
    }
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        ...
        return ValidationResult.CreateFromValidationFailure(
            ValidatorName,
            "The value must not contain items matching all of the specified predicates.",
            parameterName,
            blackboard,
            contextList);
    }
    ...
    public static string? EnsureDoesNotContainAll(this string? value, string[] substrings,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = ValidateDoesNotContainAll(value, substrings, blackboard, parameterName);
        if (!result.IsValid)
        {
    ...
    public static string? EnsureDoesNotContainAll(this string? value, StringComparison comparisonType,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = ValidateDoesNotContainAll(value, comparisonType, substrings, blackboard, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static string? EnsureDoesNotContainAll(this string? value, ICollection<char> characters,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = ValidateDoesNotContainAll(value, characters, blackboard, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static string? EnsureDoesNotContainAll(this string? value, StringComparison comparisonType,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = ValidateDoesNotContainAll(value, comparisonType, characters, blackboard, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static IEnumerable<T>? EnsureDoesNotContainAll<T>(this IEnumerable<T>? value, T[] items,
        IBlackboard? blackboard = null, [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = ValidateDoesNotContainAll(value, items, blackboard, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
    ...
    public static IEnumerable<T>? EnsureDoesNotContainAll<T>(this IEnumerable<T>? value,
        ...
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var result = ValidateDoesNotContainAll(value, predicates, blackboard, parameterName);
        if (!result.IsValid)
        {
            throw result.ValidationException!;
        }
