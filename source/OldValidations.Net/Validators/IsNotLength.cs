...
public static class IsNotLength
{
    ...
    {
        return !value.CheckIsLength(expectedLength, mode);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsNotLength<T>(this Memory<T> value, int expectedLength,
        LengthCheckMode mode = LengthCheckMode.ExactLength,
        [CallerArgumentExpression(nameof(value))] string? parameterName = null)
    {
        var validationResult = value.ValidateIsNotLength(expectedLength, mode, null, parameterName);
    ...
    /// <exception cref="ValidationException">Thrown when the collection length matches the criteria.</exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void EnsureIsNotLength<T>(this T? value, int expectedLength,
        LengthCheckMode mode = LengthCheckMode.ExactLength,
